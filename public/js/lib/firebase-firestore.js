import { _registerComponent as e, registerVersion as t, _getProvider, getApp as n, _removeServiceInstance as i, SDK_VERSION as s } from "/js/lib/firebase-app.js";
const stringToByteArray$1 = function (e) {
        ...
        for (let i = 0; i < e.length; i++) {
            ...
            s < 128
                ...
                : 55296 == (64512 & s) && i + 1 < e.length && 56320 == (64512 & e.charCodeAt(i + 1))
                ? ((s = 65536 + ((1023 & s) << 10) + (1023 & e.charCodeAt(++i))), (t[n++] = (s >> 18) | 240), (t[n++] = ((s >> 12) & 63) | 128), (t[n++] = ((s >> 6) & 63) | 128), (t[n++] = (63 & s) | 128))
...
const _ = { debug: l.DEBUG, verbose: l.VERBOSE, info: l.INFO, warn: l.WARN, error: l.ERROR, silent: l.SILENT },
    h = l.INFO,
    d = { [l.DEBUG]: "log", [l.VERBOSE]: "log", [l.INFO]: "info", [l.WARN]: "warn", [l.ERROR]: "error" },
...
e: {
    var L = "",
        B = ((D = pa()), k ? /rv:([^\);]+)(\)|;)/.exec(D) : M ? /Edge\/([\d\.]+)/.exec(D) : x ? /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(D) : O ? /WebKit\/(\S+)/.exec(D) : F ? /(?:Version)[ \/]?(\S+)/.exec(D) : void 0);
    if ((B && (L = B ? B[1] : ""), x)) {
        var q = ya();
    ...
    if (
        ...
        (this.relatedTarget = t),
            i
                ...
                : ((this.clientX = void 0 !== e.clientX ? e.clientX : e.pageX), (this.clientY = void 0 !== e.clientY ? e.clientY : e.pageY), (this.screenX = e.screenX || 0), (this.screenY = e.screenY || 0)),
            ...
            (this.pointerType = "string" == typeof e.pointerType ? e.pointerType : K[e.pointerType] || ""),
            (this.state = e.state),
            (this.i = e),
...
function ab(e, t, n, i, s, o) {
    ...
    if (
        ...
        v || (s = u), void 0 === s && (s = !1), e.addEventListener(t.toString(), i, s);
...
function fb(e, t, n, i, s) {
    if (Array.isArray(t)) for (var o = 0; o < t.length; o++) fb(e, t[o], n, i, s);
        ...
        (i = p(i) ? !!i.capture : !!i),
            (n = $a(n)),
            e && e[Q]
                ? ((e = e.i), (t = String(t).toString()) in e.g && -1 < (n = Ta((o = e.g[t]), n, i, s)) && (Ma(o[n]), Array.prototype.splice.call(o, n, 1), 0 == o.length && (delete e.g[t], e.h--)))
                : e && (e = bb(e)) && ((t = e.g[t.toString()]), (e = -1), t && (e = Ta(t, n, i, s)), (n = -1 < e ? t[e] : null) && gb(n));
}
function gb(e) {
    if ("number" != typeof e && e && !e.fa) {
        ...
        if (t && t[Q]) Ua(t.i, e);
            ...
            var n = e.type,
                i = e.proxy;
            t.removeEventListener ? t.removeEventListener(n, i, e.capture) : t.detachEvent ? t.detachEvent(db(n), i) : t.addListener && t.removeListener && t.removeListener(i),
                (n = bb(t)) ? (Ua(n, e), 0 == n.h && ((n.src = null), (t[W] = null))) : Ma(e);
        }
    }
}
function db(e) {
...
function C$1(e, t) {
    ...
    if (((s = ib((u = t.g = e), i, !0, t) && s), (s = ib(u, i, !1, t) && s), n)) for (o = 0; o < n.length; o++) s = ib((u = t.g = n[o]), i, !1, t) && s;
}
function ib(e, t, n, i) {
...
r(wb, B$1),
    ...
    (m.qb = function () {
        if (this.ga) {
            ...
            0 < e && e < 0.8 * this.h ? (this.T = this.g.setTimeout(this.j, this.h - e)) : (this.T && (this.g.clearTimeout(this.T), (this.T = null)), C$1(this, "tick"), this.ga && (xb(this), this.start()));
        }
    }),
    (m.start = function () {
                            ...
                            if (Array.isArray(n[e])) {
                                ...
                                if (!(2 > i.length)) {
                                    ...
                                    if (Array.isArray(s) && !(1 > s.length)) {
                                        var o = s[0];
                                        if ("noop" != o && "stop" != o && "close" != o) for (var u = 1; u < s.length; u++) s[u] = "";
                                    }
                                }
                            }
                    return Y(n);
...
var ie = { NO_ERROR: 0, rb: 1, Eb: 2, Db: 3, yb: 4, Cb: 5, Fb: 6, Qa: 7, TIMEOUT: 8, Ib: 9 },
    se = { wb: "complete", Sb: "success", Ra: "error", Qa: "abort", Kb: "ready", Lb: "readystatechange", TIMEOUT: "timeout", Gb: "incrementaldata", Jb: "progress", zb: "downloadprogress", $b: "uploadprogress" };
function Ub() {}
function Vb(e) {
    return e.h || (e.h = e.i());
}
...
function ic(e, t) {
    ...
    Array.isArray(i) || (i = [String(i)]),
        ...
        (t = e.I ? Pa(e.I) : {}),
        e.u ? (e.v || (e.v = "POST"), (t["Content-Type"] = "application/x-www-form-urlencoded"), e.g.ha(e.B, e.v, e.u, t)) : ((e.v = "GET"), e.g.ha(e.B, e.v, null, t)),
        Ob(),
...
function rc(e, t, n) {
    ...
    oc(e) && 0 != e.o && ((e.h.g = e.h.g.slice(e.o)), (e.o = 0)),
        ...
        (e.i = e.i && s),
        s
            ? 0 < n.length && !e.ba && ((e.ba = !0), (t = e.l).g == e && t.ca && !t.M && (t.l.info("Great, no buffering proxy detected. Bytes received: " + n.length), vc(t), (t.M = !0), F$1(11)))
        ...
        try {
            if (e == this.g)
                e: {
                    ...
                    var t = this.g.Ia();
                    this.g.da();
                    if (!(3 > d) && (3 != d || N || (this.g && (this.h.h || this.g.ja() || mc(this.g))))) {
                        ...
                        t: if (oc(this)) {
                            ...
                            for (t = 0; t < s; t++) (this.h.h = !0), (e += this.h.i.decode(i[t], { stream: o && t == s - 1 }));
                        ...
                        if (
                            ...
                            if (this.aa && !this.K) {
                                ...
                                D$1(this.j, this.m, n, "Initial handshake response via X-HTTP-Initial-Response"), (this.K = !0), qc(this, n);
                            }
                            this.S ? (rc(this, d, u), N && this.i && 3 == d && (Eb(this.U, this.V, "tick", this.mb), this.V.start())) : (D$1(this.j, this.m, u, null), qc(this, u)),
                                4 == d && I(this),
                                this.i && !this.J && (4 == d ? sc(this.l, this) : ((this.i = !1), jc(this)));
                        } else
                            (function tc(e) {
                                const t = {};
                                ...
                                400 == n && 0 < u.indexOf("Unknown SID") ? ((this.s = 3), F$1(12)) : ((this.s = 0), F$1(13)),
                                I(this),
                                pc(this);
                    }
                }
...
function M$1(e) {
    if (((this.g = this.s = this.j = ""), (this.m = null), (this.o = this.l = ""), (this.h = !1), e instanceof M$1)) {
        ...
        e && (t = String(e).match(_e))
            ? ((this.h = !1), Nc(this, t[1] || "", !0), (this.s = Rc(t[2] || "")), (this.g = Rc(t[3] || "", !0)), Oc(this, t[4]), (this.l = Rc(t[5] || "", !0)), Qc(this, t[6] || "", !0), (this.o = Rc(t[7] || "")))
...
M$1.prototype.toString = function () {
    ...
    var n = this.g;
    return (
        (n || "file" == t) && (e.push("//"), (t = this.s) && e.push(Sc(t, he, !0), "@"), e.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), null != (n = this.m) && e.push(":", String(n))),
        (n = this.l) && (this.g && "/" != n.charAt(0) && e.push("/"), e.push(Sc(n, "/" == n.charAt(0) ? me : de, !0))),
...
function cd(e) {
    (this.l = e || Ie),
        E.PerformanceNavigationTiming ? (e = 0 < (e = E.performance.getEntriesByType("navigation")).length && ("hq" == e[0].nextHopProtocol || "h2" == e[0].nextHopProtocol)) : (e = !!(E.g && E.g.Ka && E.g.Ka() && E.g.Ka().dc)),
        (this.j = e ? this.l : 1),
        (this.g = null),
...
((m = md.prototype).open = function (e, t) {
    if (this.readyState != pe) throw (this.abort(), Error("Error reopening a connection"));
...
function Hc(e) {
    if ((Fd(e), 3 == e.H)) {
        var t = e.W++,
            n = G$1(e.I);
        if ((K$1(n, "SID", e.K), K$1(n, "RID", t), K$1(n, "TYPE", "terminate"), Gd(e, n), ((t = new bc(e, e.l, t)).L = 2), (t.A = hc(G$1(n))), (n = !1), E.navigator && E.navigator.sendBeacon))
            try {
                n = E.navigator.sendBeacon(t.A.toString(), "");
            } catch (e) {}
        !n && E.Image && ((new Image().src = t.A), (n = !0)), n || ((t.g = lc(t.l, null)), t.g.ha(t.A)), (t.G = Date.now()), jc(t);
    }
    Hd(e);
}
function zc(e) {
...
function lc(e, t, n) {
    ...
    return (t = e.Ha && !e.va ? new P(new ld({ ob: n })) : new P(e.va)).Oa(e.J), t;
}
function Nd() {}
function Od() {
...
function Q$1(e, t) {
    B$1.call(this),
        ...
        t && t.messageContentType && (e ? (e["X-WebChannel-Content-Type"] = t.messageContentType) : (e = { "X-WebChannel-Content-Type": t.messageContentType })),
        ...
        (t = t && t.httpSessionIdParam) && !x$1(t) && ((this.g.F = t), null !== (e = this.h) && t in e && t in (e = this.h) && delete e[t]),
        (this.j = new R(this));
}
function Pd(e) {
...
function Sd(e, t, n) {
    n || (n = 0);
    var i = Array(16);
    if ("string" == typeof t) for (var s = 0; 16 > s; ++s) i[s] = t.charCodeAt(n++) | (t.charCodeAt(n++) << 8) | (t.charCodeAt(n++) << 16) | (t.charCodeAt(n++) << 24);
    else for (s = 0; 16 > s; ++s) i[s] = t[n++] | (t[n++] << 8) | (t[n++] << 16) | (t[n++] << 24);
                                                                                                                                                                                        ...
                                                                                                                                                                                        (n =
                                                                                                                                                                                            (s =
                                                                                                                                                                                                ...
                                                                                                                                                                                                ((((u =
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    (u >>> 15))) +
                                                                                                                                                                                            ((((u =
                                                                                                                                                                                                (n + (t ^ (s & (o ^ t))) + i[15] + 1236535329) &
                                                                                                                                                                                                4294967295) <<
                                                                                                                                                                                                22) &
                                                                                                                                                                                                4294967295) |
                                                                                                                                                                                                (u >>> 10))) +
                                                                                                                                                                                        ((((u =
                                                                                                                                                                                            (t + (s ^ (o & (n ^ s))) + i[1] + 4129170786) &
                                                                                                                                                                                            4294967295) <<
                                                                                                                                                                                            5) &
                                                                                                                                                                                            4294967295) |
                                                                                                                                                                                            (u >>> 27))) +
                                                                                                                                                                                    ((((u =
                                                                                                                                                                                        (o + (n ^ (s & (t ^ n))) + i[6] + 3225465664) &
                                                                                                                                                                                        4294967295) <<
                                                                                                                                                                                        9) &
                                                                                                                                                                                        4294967295) |
                                                                                                                                                                                        (u >>> 23))) +
                                                                                                                                                                                ((((u =
                                                                                                                                                                                    (s + (t ^ (n & (o ^ t))) + i[11] + 643717713) &
                                                                                                                                                                                    4294967295) <<
                                                                                                                                                                                    14) &
                                                                                                                                                                                    4294967295) |
                                                                                                                                                                                    (u >>> 18))) +
                                                                                                                                                                            ((((u =
                                                                                                                                                                                (n + (o ^ (t & (s ^ o))) + i[0] + 3921069994) & 4294967295) <<
                                                                                                                                                                                20) &
                                                                                                                                                                                4294967295) |
                                                                                                                                                                                (u >>> 12))) +
                                                                                                                                                                        ((((u = (t + (s ^ (o & (n ^ s))) + i[5] + 3593408605) & 4294967295) <<
                                                                                                                                                                            5) &
                                                                                                                                                                            4294967295) |
                                                                                                                                                                            (u >>> 27))) +
                                                                                                                                                                    ((((u = (o + (n ^ (s & (t ^ n))) + i[10] + 38016083) & 4294967295) << 9) &
                                                                                                                                                                        4294967295) |
                                                                                                                                                                        (u >>> 23))) +
                                                                                                                                                                ((((u = (s + (t ^ (n & (o ^ t))) + i[15] + 3634488961) & 4294967295) << 14) &
                                                                                                                                                                    4294967295) |
                                                                                                                                                                    (u >>> 18))) +
                                                                                                                                                            ((((u = (n + (o ^ (t & (s ^ o))) + i[4] + 3889429448) & 4294967295) << 20) &
                                                                                                                                                                4294967295) |
                                                                                                                                                                (u >>> 12))) +
                                                                                                                                                        ((((u = (t + (s ^ (o & (n ^ s))) + i[9] + 568446438) & 4294967295) << 5) & 4294967295) |
                                                                                                                                                            (u >>> 27))) +
                                                                                                                                                    ((((u = (o + (n ^ (s & (t ^ n))) + i[14] + 3275163606) & 4294967295) << 9) & 4294967295) |
                                                                                                                                                        (u >>> 23))) +
                                                                                                                                                ((((u = (s + (t ^ (n & (o ^ t))) + i[3] + 4107603335) & 4294967295) << 14) & 4294967295) |
                                                                                                                                                    (u >>> 18))) +
                                                                                                                                            ((((u = (n + (o ^ (t & (s ^ o))) + i[8] + 1163531501) & 4294967295) << 20) & 4294967295) |
                                                                                                                                                (u >>> 12))) +
                                                                                                                                        ((((u = (t + (s ^ (o & (n ^ s))) + i[13] + 2850285829) & 4294967295) << 5) & 4294967295) |
                                                                                                                                            (u >>> 27))) +
                                                                                                                                    ((((u = (o + (n ^ (s & (t ^ n))) + i[2] + 4243563512) & 4294967295) << 9) & 4294967295) | (u >>> 23))) +
                                                                                                                                ((((u = (s + (t ^ (n & (o ^ t))) + i[7] + 1735328473) & 4294967295) << 14) & 4294967295) | (u >>> 18))) +
                                                                                                                            ((((u = (n + (o ^ (t & (s ^ o))) + i[12] + 2368359562) & 4294967295) << 20) & 4294967295) | (u >>> 12))) +
                                                                                                                        ((((u = (t + (n ^ s ^ o) + i[5] + 4294588738) & 4294967295) << 4) & 4294967295) | (u >>> 28))) +
                                                                                                                    ((((u = (o + (t ^ n ^ s) + i[8] + 2272392833) & 4294967295) << 11) & 4294967295) | (u >>> 21))) +
                                                                                                                ((((u = (s + (o ^ t ^ n) + i[11] + 1839030562) & 4294967295) << 16) & 4294967295) | (u >>> 16))) +
                                                                                                            ((((u = (n + (s ^ o ^ t) + i[14] + 4259657740) & 4294967295) << 23) & 4294967295) | (u >>> 9))) +
                                                                                                        ((((u = (t + (n ^ s ^ o) + i[1] + 2763975236) & 4294967295) << 4) & 4294967295) | (u >>> 28))) +
                                                                                                    ((((u = (o + (t ^ n ^ s) + i[4] + 1272893353) & 4294967295) << 11) & 4294967295) | (u >>> 21))) +
                                                                                                ((((u = (s + (o ^ t ^ n) + i[7] + 4139469664) & 4294967295) << 16) & 4294967295) | (u >>> 16))) +
                                                                                            ((((u = (n + (s ^ o ^ t) + i[10] + 3200236656) & 4294967295) << 23) & 4294967295) | (u >>> 9))) +
                                                                                        ((((u = (t + (n ^ s ^ o) + i[13] + 681279174) & 4294967295) << 4) & 4294967295) | (u >>> 28))) +
                                                                                    ((((u = (o + (t ^ n ^ s) + i[0] + 3936430074) & 4294967295) << 11) & 4294967295) | (u >>> 21))) +
                                                                                ((((u = (s + (o ^ t ^ n) + i[3] + 3572445317) & 4294967295) << 16) & 4294967295) | (u >>> 16))) +
                                                                            ((((u = (n + (s ^ o ^ t) + i[6] + 76029189) & 4294967295) << 23) & 4294967295) | (u >>> 9))) +
                                                                        ((((u = (t + (n ^ s ^ o) + i[9] + 3654602809) & 4294967295) << 4) & 4294967295) | (u >>> 28))) +
                                                                    ((((u = (o + (t ^ n ^ s) + i[12] + 3873151461) & 4294967295) << 11) & 4294967295) | (u >>> 21))) +
                                                                ((((u = (s + (o ^ t ^ n) + i[15] + 530742520) & 4294967295) << 16) & 4294967295) | (u >>> 16))) +
                                                            ((((u = (n + (s ^ o ^ t) + i[2] + 3299628645) & 4294967295) << 23) & 4294967295) | (u >>> 9))) +
                                                        ((((u = (t + (s ^ (n | ~o)) + i[0] + 4096336452) & 4294967295) << 6) & 4294967295) | (u >>> 26))) +
                                                    ((((u = (o + (n ^ (t | ~s)) + i[7] + 1126891415) & 4294967295) << 10) & 4294967295) | (u >>> 22))) +
                                                ((((u = (s + (t ^ (o | ~n)) + i[14] + 2878612391) & 4294967295) << 15) & 4294967295) | (u >>> 17))) +
                                            ((((u = (n + (o ^ (s | ~t)) + i[5] + 4237533241) & 4294967295) << 21) & 4294967295) | (u >>> 11))) +
                                        ((((u = (t + (s ^ (n | ~o)) + i[12] + 1700485571) & 4294967295) << 6) & 4294967295) | (u >>> 26))) +
                                    ((((u = (o + (n ^ (t | ~s)) + i[3] + 2399980690) & 4294967295) << 10) & 4294967295) | (u >>> 22))) +
                                ((((u = (s + (t ^ (o | ~n)) + i[10] + 4293915773) & 4294967295) << 15) & 4294967295) | (u >>> 17))) +
                            ((((u = (n + (o ^ (s | ~t)) + i[1] + 2240044497) & 4294967295) << 21) & 4294967295) | (u >>> 11))) +
                        ((((u = (t + (s ^ (n | ~o)) + i[8] + 1873313359) & 4294967295) << 6) & 4294967295) | (u >>> 26))) +
                    ((((u = (o + (n ^ (t | ~s)) + i[15] + 4264355552) & 4294967295) << 10) & 4294967295) | (u >>> 22))) +
                ((((u = (s + (t ^ (o | ~n)) + i[6] + 2734768916) & 4294967295) << 15) & 4294967295) | (u >>> 17))) +
            ((((u = (n + (o ^ (s | ~t)) + i[13] + 1309151649) & 4294967295) << 21) & 4294967295) | (u >>> 11))) +
            ((o = (t = n + ((((u = (t + (s ^ (n | ~o)) + i[4] + 4149444226) & 4294967295) << 6) & 4294967295) | (u >>> 26))) + ((((u = (o + (n ^ (t | ~s)) + i[11] + 3174756917) & 4294967295) << 10) & 4294967295) | (u >>> 22))) ^
                ((s = o + ((((u = (s + (t ^ (o | ~n)) + i[2] + 718787259) & 4294967295) << 15) & 4294967295) | (u >>> 17))) | ~t)) +
            i[9] +
            3951481745) &
        4294967295),
        (e.g[0] = (e.g[0] + t) & 4294967295),
        (e.g[1] = (e.g[1] + (s + (((u << 21) & 4294967295) | (u >>> 11)))) & 4294967295),
...
((m = P.prototype).Oa = function (e) {
    ...
    (m.ha = function (e, t, n, i) {
        ...
        if (((e = n || ""), (n = new Map(this.headers)), i))
            if (Object.getPrototypeOf(i) === Object.prototype) for (var s in i) n.set(s, i[s]);
            else {
            ...
            wd(this),
                0 < this.B &&
                    ((this.L = (function xd(e) {
                        ...
                        ? ((this.g.timeout = this.B), (this.g.ontimeout = q$1(this.ua, this)))
        ...
        if (this.m)
            if (((this.m = null), 1 == this.H)) {
                if (!e) {
                    ...
                    let o = this.s;
                    if ((this.U && (o ? ((o = Pa(o)), Ra(o, this.U)) : (o = this.U)), null !== this.o || this.O || ((s.I = o), (o = null)), this.P))
                        e: {
                    ...
                    (t = Kd(this, s, t)),
                        ...
                        Gd(this, n),
                        o && (this.O ? (t = "headers=" + encodeURIComponent(String(Bd(o))) + "&" + t) : this.o && Cd(n, this.o, o)),
                        Cc(this.i, s),
                        this.bb && K$1(n, "TYPE", "init"),
                        this.P ? (K$1(n, "$req", t), K$1(n, "SID", "null"), (s.aa = !0), gc(s, n, null)) : gc(s, n, t),
                        (this.H = 2);
                }
    ...
    (S$1.prototype.l = function () {
        ...
        for (this.j(e), e = Array(16), t = n = 0; 4 > t; ++t) for (var i = 0; 32 > i; i += 8) e[n++] = (this.g[t] >>> i) & 255;
        return e;
    });
var Re = {};
function Td(e) {
        ...
        return (
            ...
            this.auth
                ? this.auth
                      ...
                      .then((t) =>
                          this.i !== e
                              ? (__PRIVATE_logDebug("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken())
                              : t
                              ? (__PRIVATE_hardAssert("string" == typeof t.accessToken), new __PRIVATE_OAuthToken(t.accessToken, this.currentUser))
                              : null
                      )
...
class FieldPath$1 extends BasePath {
    ...
    canonicalString() {
        return this.toArray()
            .map((e) => ((e = e.replace(/\\/g, "\\\\").replace(/`/g, "\\`")), FieldPath$1.isValidIdentifier(e) || (e = "`" + e + "`"), e))
            .join(".");
    }
    toString() {
        return this.canonicalString();
...
function __PRIVATE_fieldIndexSemanticComparator(e, t) {
    ...
    if (0 !== n) return n;
    for (let i = 0; i < Math.min(e.fields.length, t.fields.length); ++i) if (((n = __PRIVATE_indexSegmentComparator(e.fields[i], t.fields[i])), 0 !== n)) return n;
    ...
    constructor(e, t, n) {
        (this.name = e),
            ...
            12.2 === __PRIVATE_SimpleDb.S(getUA()) &&
                __PRIVATE_logError("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    static delete(e) {
                        ...
                        (i.onerror = (t) => {
                            ...
                            "VersionError" === i.name
                                ...
                                ? n(
                                      new FirestoreError(
                                          $e.FAILED_PRECONDITION,
                                          "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + i
                                      )
                                  )
...
class __PRIVATE_SimpleDbStore {
    ...
    put(e, t) {
        let n;
        return (
            void 0 !== t ? (__PRIVATE_logDebug("SimpleDb", "PUT", this.store.name, e, t), (n = this.store.put(t, e))) : (__PRIVATE_logDebug("SimpleDb", "PUT", this.store.name, "<auto-key>", e), (n = this.store.put(e))),
...
class __PRIVATE_IndexBackfiller {
        ...
        return PersistencePromise.doWhile(
            ...
            () =>
                this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next((t) => {
                    if (null !== t && !n.has(t))
                        return (
                            __PRIVATE_logDebug("IndexBackiller", `Processing collection: ${t}`),
    ...
    re(e, t, n) {
        return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e, t).next((i) =>
            this.localStore.localDocuments.getNextDocuments(e, t, i, n).next((n) => {
                const s = n.changes;
                return this.localStore.indexManager
                    .updateIndexEntries(e, s)
                    .next(() => this.ie(i, n))
                    .next((n) => (__PRIVATE_logDebug("IndexBackiller", `Updating offset: ${n}`), this.localStore.indexManager.updateCollectionGroup(e, t, n)))
                    .next(() => s.size);
            })
        );
    }
...
class ByteString {
    ...
    [Symbol.iterator]() {
        let e = 0;
        return { next: () => (e < this.binaryString.length ? { value: this.binaryString.charCodeAt(e++), done: !1 } : { value: void 0, done: !0 }) };
    }
    toBase64() {
...
function __PRIVATE_normalizeTimestamp(e) {
    ...
    return { seconds: __PRIVATE_normalizeNumber(e.seconds), nanos: __PRIVATE_normalizeNumber(e.nanos) };
}
    ...
    switch (n) {
        ...
        case 8:
            return (function __PRIVATE_geoPointEquals(e, t) {
                return (
                    __PRIVATE_normalizeNumber(e.geoPointValue.latitude) === __PRIVATE_normalizeNumber(t.geoPointValue.latitude) && __PRIVATE_normalizeNumber(e.geoPointValue.longitude) === __PRIVATE_normalizeNumber(t.geoPointValue.longitude)
                );
            })(e, t);
        case 2:
        ...
        case 10:
            return (function __PRIVATE_objectEquals(e, t) {
                ...
                for (const e in n) if (n.hasOwnProperty(e) && (void 0 === i[e] || !__PRIVATE_valueEquals(n[e], i[e]))) return !1;
                return !0;
            })(e, t);
        default:
            return fail();
...
class ObjectValue {
    ...
    getFieldsMap(e) {
        ...
        for (let n = 0; n < e.length; ++n) {
            ...
            (__PRIVATE_isMapValue(i) && i.mapValue.fields) || ((i = { mapValue: { fields: {} } }), (t.mapValue.fields[e.get(n)] = i)), (t = i);
        }
...
class FieldFilter extends Filter {
    ...
    matches(e) {
        ...
        return "!=" === this.op
            ? null !== t && this.matchesComparison(__PRIVATE_valueCompare(t, this.value))
            : null !== t && __PRIVATE_typeOrder(this.value) === __PRIVATE_typeOrder(t) && this.matchesComparison(__PRIVATE_valueCompare(t, this.value));
    }
    matchesComparison(e) {
        switch (this.op) {
            case "<":
...
function __PRIVATE_targetGetAscendingBound(e, t, n) {
    ...
    for (const n of __PRIVATE_targetGetFieldFiltersForPath(e, t)) {
        ...
        __PRIVATE_lowerBoundCompare({ value: i, inclusive: s }, { value: e, inclusive: t }) < 0 && ((i = e), (s = t));
    }
    if (null !== n)
        for (let o = 0; o < e.orderBy.length; ++o)
            if (e.orderBy[o].field.isEqual(t)) {
                const e = n.position[o];
                __PRIVATE_lowerBoundCompare({ value: i, inclusive: s }, { value: e, inclusive: n.inclusive }) < 0 && ((i = e), (s = n.inclusive));
                break;
            }
...
function __PRIVATE_targetGetDescendingBound(e, t, n) {
    ...
    for (const n of __PRIVATE_targetGetFieldFiltersForPath(e, t)) {
        ...
        __PRIVATE_upperBoundCompare({ value: i, inclusive: s }, { value: e, inclusive: t }) > 0 && ((i = e), (s = t));
    }
    if (null !== n)
        for (let o = 0; o < e.orderBy.length; ++o)
            if (e.orderBy[o].field.isEqual(t)) {
                const e = n.position[o];
                __PRIVATE_upperBoundCompare({ value: i, inclusive: s }, { value: e, inclusive: n.inclusive }) > 0 && ((i = e), (s = n.inclusive));
                break;
            }
    return { value: i, inclusive: s };
}
        ...
        return (
            ...
            e.orderBy.length > 0 &&
                (t += `, orderBy: [${e.orderBy
                    ...
                    .join(", ")}]`),
            e.startAt && ((t += ", startAt: "), (t += e.startAt.inclusive ? "b:" : "a:"), (t += e.startAt.position.map((e) => canonicalId(e)).join(","))),
            e.endAt && ((t += ", endAt: "), (t += e.endAt.inclusive ? "a:" : "b:"), (t += e.endAt.position.map((e) => canonicalId(e)).join(","))),
            `Target(${t})`
        );
...
class ObjectMap {
    ...
    set(e, t) {
        ...
        for (let n = 0; n < i.length; n++) if (this.equalsFn(i[n][0], e)) return void (i[n] = [e, t]);
    ...
    delete(e) {
        ...
        for (let i = 0; i < n.length; i++) if (this.equalsFn(n[i][0], e)) return 1 === n.length ? delete this.inner[t] : n.splice(i, 1), this.innerSize--, !0;
        return !1;
    }
    forEach(e) {
...
function __PRIVATE_applyTransformOperationToLocalView(e, t, n) {
    return e instanceof __PRIVATE_ServerTimestampTransform
        ? (function serverTimestamp$1(e, t) {
              const n = { fields: { __type__: { stringValue: "server_timestamp" }, __local_write_time__: { timestampValue: { seconds: e.seconds, nanos: e.nanoseconds } } } };
        ...
        : (function __PRIVATE_applyNumericIncrementTransformOperationToLocalView(e, t) {
                        ...
                        (function __PRIVATE_fieldTransformEquals(e, t) {
                            return (
                                ...
                                (function __PRIVATE_transformOperationEquals(e, t) {
                                    return (e instanceof __PRIVATE_ArrayUnionTransformOperation && t instanceof __PRIVATE_ArrayUnionTransformOperation) ||
                                        (e instanceof __PRIVATE_ArrayRemoveTransformOperation && t instanceof __PRIVATE_ArrayRemoveTransformOperation)
                                        ? __PRIVATE_arrayEquals(e.elements, t.elements, __PRIVATE_valueEquals)
                                        : e instanceof __PRIVATE_NumericIncrementTransformOperation && t instanceof __PRIVATE_NumericIncrementTransformOperation
...
class MutationBatch {
    ...
    isEqual(e) {
        return (
            this.batchId === e.batchId && __PRIVATE_arrayEquals(this.mutations, e.mutations, (e, t) => __PRIVATE_mutationEquals(e, t)) && __PRIVATE_arrayEquals(this.baseMutations, e.baseMutations, (e, t) => __PRIVATE_mutationEquals(e, t))
        );
    }
}
...
class RemoteEvent {
    ...
    static createSynthesizedRemoteEventForCurrentChange(e, t, n) {
        const i = new Map();
        return (
            i.set(e, TargetChange.createSynthesizedTargetChangeForCurrentChange(e, t, n)), new RemoteEvent(SnapshotVersion.min(), i, new SortedMap(__PRIVATE_primitiveComparator), __PRIVATE_mutableDocumentMap(), __PRIVATE_documentKeySet())
        );
    }
}
class TargetChange {
        ...
        if (i) {
            ...
            if (__PRIVATE_targetIsDocumentTarget(s))
                ...
                if (i !== n) {
                    ...
                    null == At ||
                        At.tt(
                            (function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e, t, n, i, s) {
                                var o, u, l, _, h, d;
                                const m = { localCacheCount: e, existenceFilterCount: t.count, databaseId: n.database, projectId: n.projectId },
                                    f = t.unchangedNames;
                                return (
                                    f &&
                                        (m.bloomFilter = {
...
function toTimestamp(e, t) {
    return e.useProto3Json ? `${new Date(1e3 * t.seconds).toISOString().replace(/\.\d*/, "").replace("Z", "")}.${("000000000" + t.nanoseconds).slice(-9)}Z` : { seconds: "" + t.seconds, nanos: t.nanoseconds };
}
...
function toMutation(e, t) {
    ...
    else if (t instanceof __PRIVATE_PatchMutation) n = { update: __PRIVATE_toMutationDocument(e, t.key, t.data), updateMask: __PRIVATE_toDocumentMask(t.fieldMask) };
    else {
        ...
        t.fieldTransforms.length > 0 &&
            (n.updateTransforms = t.fieldTransforms.map((e) =>
                (function __PRIVATE_toFieldTransform(e, t) {
                    const n = t.transform;
                    if (n instanceof __PRIVATE_ServerTimestampTransform) return { fieldPath: t.field.canonicalString(), setToServerValue: "REQUEST_TIME" };
                    if (n instanceof __PRIVATE_ArrayUnionTransformOperation) return { fieldPath: t.field.canonicalString(), appendMissingElements: { values: n.elements } };
                    if (n instanceof __PRIVATE_ArrayRemoveTransformOperation) return { fieldPath: t.field.canonicalString(), removeAllFromArray: { values: n.elements } };
                    if (n instanceof __PRIVATE_NumericIncrementTransformOperation) return { fieldPath: t.field.canonicalString(), increment: n.Ie };
                    throw fail();
                })(0, e)
            )),
...
function __PRIVATE_toQueryTarget(e, t) {
    ...
    null !== t.collectionGroup
        ? ((n.parent = __PRIVATE_toQueryPath(e, i)), (n.structuredQuery.from = [{ collectionId: t.collectionGroup, allDescendants: !0 }]))
        : ((n.parent = __PRIVATE_toQueryPath(e, i.popLast())), (n.structuredQuery.from = [{ collectionId: i.lastSegment() }]));
        ...
        if (0 !== e.length)
            return e.map((e) =>
                (function __PRIVATE_toPropertyOrder(e) {
                    return { field: __PRIVATE_toFieldPathReference(e.field), direction: __PRIVATE_toDirection(e.dir) };
                })(e)
            );
    })(t.orderBy);
...
function __PRIVATE_toFilter(e) {
    return e instanceof FieldFilter
        ? (function __PRIVATE_toUnaryOrFieldFilter(e) {
              if ("==" === e.op) {
                  if (__PRIVATE_isNanValue(e.value)) return { unaryFilter: { field: __PRIVATE_toFieldPathReference(e.field), op: "IS_NAN" } };
                  if (__PRIVATE_isNullValue(e.value)) return { unaryFilter: { field: __PRIVATE_toFieldPathReference(e.field), op: "IS_NULL" } };
              } else if ("!=" === e.op) {
                  if (__PRIVATE_isNanValue(e.value)) return { unaryFilter: { field: __PRIVATE_toFieldPathReference(e.field), op: "IS_NOT_NAN" } };
                  if (__PRIVATE_isNullValue(e.value)) return { unaryFilter: { field: __PRIVATE_toFieldPathReference(e.field), op: "IS_NOT_NULL" } };
              }
              return { fieldFilter: { field: __PRIVATE_toFieldPathReference(e.field), op: __PRIVATE_toOperatorName(e.op), value: e.value } };
          })(e)
        : e instanceof CompositeFilter
        ? (function __PRIVATE_toCompositeFilter(e) {
              const t = e.getFilters().map((e) => __PRIVATE_toFilter(e));
              return 1 === t.length ? t[0] : { compositeFilter: { op: __PRIVATE_toCompositeOperatorName(e.op), filters: t } };
          })(e)
        : fail();
}
...
function __PRIVATE_toDbRemoteDocument(e, t) {
    const n = t.key,
        i = { prefixPath: n.getCollectionPath().popLast().toArray(), collectionGroup: n.collectionGroup, documentId: n.path.lastSegment(), readTime: __PRIVATE_toDbTimestampKey(t.readTime), hasCommittedMutations: t.hasCommittedMutations };
    if (t.isFoundDocument())
        i.document = (function __PRIVATE_toDocument(e, t) {
            return { name: __PRIVATE_toName(e, t.key), fields: t.data.value.mapValue.fields, updateTime: toTimestamp(e, t.version.toTimestamp()), createTime: toTimestamp(e, t.createTime.toTimestamp()) };
        })(e.ut, t);
    else if (t.isNoDocument()) i.noDocument = { path: n.path.toArray(), readTime: __PRIVATE_toDbTimestamp(t.version) };
    else {
        if (!t.isUnknownDocument()) return fail();
        i.unknownDocument = { path: n.path.toArray(), version: __PRIVATE_toDbTimestamp(t.version) };
    }
    return i;
}
...
function __PRIVATE_fromDbTarget(e) {
    ...
    return (
        ...
        new TargetData(i, e.targetId, "TargetPurposeListen", e.lastListenSequenceNumber, t, n, ByteString.fromBase64String(e.resumeToken))
    );
}
function __PRIVATE_toDbTarget(e, t) {
    ...
    let s;
    s = __PRIVATE_targetIsDocumentTarget(t.target) ? __PRIVATE_toDocumentsTarget(e.ut, t.target) : __PRIVATE_toQueryTarget(e.ut, t.target);
    const o = t.resumeToken.toBase64();
    return { targetId: t.targetId, canonicalId: __PRIVATE_canonifyTarget(t.target), readTime: n, resumeToken: o, lastListenSequenceNumber: t.sequenceNumber, lastLimboFreeSnapshotVersion: i, query: s };
}
function __PRIVATE_fromBundledQuery(e) {
    const t = __PRIVATE_convertQueryTargetToQuery({ parent: e.parent, structuredQuery: e.structuredQuery });
...
function __PRIVATE_toDbIndexState(e, t, n, i) {
    return { indexId: e, uid: t.uid || "", sequenceNumber: n, readTime: __PRIVATE_toDbTimestamp(i.readTime), documentKey: __PRIVATE_encodeResourcePath(i.documentKey.path), largestBatchId: i.largestBatchId };
}
            ...
            .next((e) => {
                if (e)
                    return (function __PRIVATE_fromDbBundle(e) {
                        return { id: e.bundleId, createTime: __PRIVATE_fromDbTimestamp(e.createTime), version: e.version };
                    })(e);
            });
    }
    saveBundleMetadata(e, t) {
        return __PRIVATE_bundlesStore(e).put(
            (function __PRIVATE_toDbBundle(e) {
                return { bundleId: e.id, createTime: __PRIVATE_toDbTimestamp(__PRIVATE_fromVersion(e.createTime)), version: e.version };
            })(t)
        );
    }
    getNamedQuery(e, t) {
            ...
            .next((e) => {
                if (e)
                    return (function __PRIVATE_fromDbNamedQuery(e) {
                        return { name: e.name, query: __PRIVATE_fromBundledQuery(e.bundledQuery), readTime: __PRIVATE_fromDbTimestamp(e.readTime) };
                    })(e);
            });
    }
    saveNamedQuery(e, t) {
        return __PRIVATE_namedQueriesStore(e).put(
            (function __PRIVATE_toDbNamedQuery(e) {
                return { name: e.name, readTime: __PRIVATE_toDbTimestamp(__PRIVATE_fromVersion(e.readTime)), bundledQuery: e.bundledQuery };
            })(t)
        );
    }
}
...
class __PRIVATE_IndexedDbDocumentOverlayCache {
    ...
    getOverlay(e, t) {
        return __PRIVATE_documentOverlayStore(e)
            ...
            .next((e) => (e ? __PRIVATE_fromDbDocumentOverlay(this.serializer, e) : null));
    }
    getOverlays(e, t) {
    ...
    lt(e, t) {
        return __PRIVATE_documentOverlayStore(e).put(
            (function __PRIVATE_toDbDocumentOverlay(e, t, n) {
                ...
                return { userId: t, collectionPath: s, documentId: o, collectionGroup: n.mutation.key.getCollectionGroup(), largestBatchId: n.largestBatchId, overlayMutation: toMutation(e.ut, n.mutation) };
...
class __PRIVATE_OrderedCodeWriter {
    ...
    xt(e) {
        for (const t of e) {
            ...
            else if (t < "\ud800" || "\udbff" < t) this.Dt(480 | (e >>> 12)), this.Dt(128 | (63 & (e >>> 6))), this.Dt(128 | (63 & e));
            else {
...
function __PRIVATE_indexEntryComparator(e, t) {
    ...
    return 0 !== n
        ? n
        : ((n = __PRIVATE_compareByteArrays(e.arrayValue, t.arrayValue)), 0 !== n ? n : ((n = __PRIVATE_compareByteArrays(e.directionalValue, t.directionalValue)), 0 !== n ? n : DocumentKey.comparator(e.documentKey, t.documentKey)));
}
...
class __PRIVATE_TargetIndexMatcher {
    ...
    en(e) {
        if ((__PRIVATE_hardAssert(e.collectionGroup === this.collectionId), this.Xt)) return !1;
        ...
        let i = new Set(),
            s = 0,
            o = 0;
        for (; s < n.length && this.tn(n[s]); ++s) i = i.add(n[s].fieldPath.canonicalString());
...
function __PRIVATE_computeDistributedNormalForm(e) {
    ...
    return (
        ...
        __PRIVATE_isDisjunctiveNormalForm(n)
            ? n
            : (__PRIVATE_hardAssert(n instanceof CompositeFilter), __PRIVATE_hardAssert(__PRIVATE_compositeFilterIsConjunction(n)), __PRIVATE_hardAssert(n.filters.length > 1), n.filters.reduce((e, t) => __PRIVATE_applyDistribution(e, t)))
    );
}
function __PRIVATE_applyDistribution(e, t) {
    let n;
    return (
        __PRIVATE_hardAssert(e instanceof FieldFilter || e instanceof CompositeFilter),
        ...
        (n =
            e instanceof FieldFilter
                ...
                : (function __PRIVATE_applyDistributionCompositeFilters(e, t) {
                      if ((__PRIVATE_hardAssert(e.filters.length > 0 && t.filters.length > 0), __PRIVATE_compositeFilterIsConjunction(e) && __PRIVATE_compositeFilterIsConjunction(t)))
                          return __PRIVATE_compositeFilterWithAddedFilters(e, t.getFilters());
...
class __PRIVATE_IndexedDbIndexManager {
    ...
    deleteFieldIndex(e, t) {
        ...
        return n
            ...
            .next(() => s.delete(IDBKeyRange.bound([t.indexId], [t.indexId + 1], !1, !0)));
    }
    deleteAllFieldIndexes(e) {
            ...
            if (i) {
                ...
                return PersistencePromise.forEach(s, (s, o) => {
                    ...
                    const u = (function __PRIVATE_targetGetArrayValues(e, t) {
                            ...
                            for (const t of __PRIVATE_targetGetFieldFiltersForPath(e, n.fieldPath))
                                switch (t.op) {
                        ...
                        l = (function __PRIVATE_targetGetNotInValues(e, t) {
                            ...
                            for (const i of __PRIVATE_fieldIndexGetDirectionalSegments(t))
                                for (const t of __PRIVATE_targetGetFieldFiltersForPath(e, i.fieldPath))
                                    switch (t.op) {
                                        case "==":
                                        case "in":
    ...
    un(e) {
        ...
        return (
            t ||
            ((t = 0 === e.filters.length ? [e] : __PRIVATE_getDnfTerms(CompositeFilter.create(e.filters, "and")).map((t) => __PRIVATE_newTarget(e.path, e.collectionGroup, e.orderBy, t.getFilters(), e.limit, e.startAt, e.endAt))),
            this.an.set(e, t),
            t)
        );
    }
    ...
    cn(e, t) {
        ...
        return this.getFieldIndexes(e, i).next((e) => {
            let t = null;
            for (const i of e) n.en(i) && (!t || i.fields.length > t.fields.length) && (t = i);
            return t;
        });
    }
    getIndexType(e, t) {
                    ...
                    ? 0 !== n &&
                      e.fields.length <
                          (function __PRIVATE_targetGetSegmentCount(e) {
                              let t = new SortedSet(FieldPath$1.comparator),
                                  n = !1;
                              for (const i of e.filters) for (const e of i.getFlattenedFilters()) e.field.isKeyField() || ("array-contains" === e.op || "array-contains-any" === e.op ? (n = !0) : (t = t.add(e.field)));
    ...
    Vn(e, t, n) {
        ...
        for (const e of n.arrayValue.values || [])
            for (const n of i) {
                ...
                i.seed(n.Ut()), __PRIVATE_FirestoreIndexValueWriter.St.ht(e, i.jt(t.kind)), s.push(i);
            }
        return s;
    }
    Rn(e, t) {
    ...
    updateCollectionGroup(e, t, n) {
        ...
        return this.fn(e).next((e) => i.W("collectionGroupIndex", IDBKeyRange.bound(t, t)).next((t) => PersistencePromise.forEach(t, (t) => s.put(__PRIVATE_toDbIndexState(t.indexId, this.user, e, n)))));
    }
    updateIndexEntries(e, t) {
        const n = new Map();
        return PersistencePromise.forEach(t, (t, i) => {
            const s = n.get(t.collectionGroup);
            return (s ? PersistencePromise.resolve(s) : this.getFieldIndexes(e, t.collectionGroup)).next(
                (s) => (
                    n.set(t.collectionGroup, s),
                    PersistencePromise.forEach(s, (n) =>
                        this.gn(e, t, n).next((t) => {
                            const s = this.pn(i, n);
                            return t.isEqual(s) ? PersistencePromise.resolve() : this.yn(e, i, n, t, s);
                        })
                    )
                )
            );
    ...
    wn(e, t, n, i) {
        return __PRIVATE_indexEntriesStore(e).put({ indexId: i.indexId, uid: this.uid, arrayValue: i.arrayValue, directionalValue: i.directionalValue, orderedDocumentKey: this.An(n, t.key), documentKey: t.key.path.toArray() });
    }
    Sn(e, t, n, i) {
        return __PRIVATE_indexEntriesStore(e).delete([i.indexId, this.uid, i.arrayValue, i.directionalValue, this.An(n, t.key), t.key.path.toArray()]);
    }
    gn(e, t, n) {
        const i = __PRIVATE_indexEntriesStore(e);
        let s = new SortedSet(__PRIVATE_indexEntryComparator);
        return i
            .Y({ index: "documentKeyIndex", range: IDBKeyRange.only([n.indexId, this.uid, this.An(n, t)]) }, (e, i) => {
    ...
    pn(e, t) {
        ...
        if (null != s) {
            ...
            if (isArray(o)) for (const s of o.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.In(s), i));
    ...
    fn(e) {
        ...
        return __PRIVATE_indexStateStore(e)
            .Y({ index: "sequenceNumberIndex", reverse: !0, range: IDBKeyRange.upperBound([this.uid, Number.MAX_SAFE_INTEGER]) }, (e, n, i) => {
...
const vt = { didRun: !1, sequenceNumbersCollected: 0, targetsRemoved: 0, documentsRemoved: 0 };
class LruParams {
    constructor(e, t, n) {
...
(LruParams.DEFAULT_COLLECTION_PERCENTILE = 10),
    ...
    (LruParams.DEFAULT = new LruParams(41943040, LruParams.DEFAULT_COLLECTION_PERCENTILE, LruParams.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)),
    (LruParams.DISABLED = new LruParams(-1, 0, 0));
class __PRIVATE_IndexedDbMutationQueue {
    constructor(e, t, n, i) {
        (this.userId = e), (this.serializer = t), (this.indexManager = n), (this.referenceDelegate = i), (this.Dn = {});
    }
    static ct(e, t, n, i) {
        ...
        return o.add({}).next((u) => {
            ...
            const l = new MutationBatch(u, t, n, i),
                _ = (function __PRIVATE_toDbMutationBatch(e, t, n) {
                    ...
                    return { userId: t, batchId: n.batchId, localWriteTimeMs: n.localWriteTime.toMillis(), baseMutations: i, mutations: s };
    ...
    lookupMutationBatch(e, t) {
        return __PRIVATE_mutationsStore(e)
            .get(t)
            .next((e) => (e ? (__PRIVATE_hardAssert(e.userId === this.userId), __PRIVATE_fromDbMutationBatch(this.serializer, e)) : null));
    }
    Cn(e, t) {
        return this.Dn[t]
    ...
    getAllMutationBatches(e) {
        ...
        return __PRIVATE_mutationsStore(e)
            ...
            .next((e) => e.map((e) => __PRIVATE_fromDbMutationBatch(this.serializer, e)));
    }
...
class __PRIVATE_IndexedDbTargetCache {
    ...
    setTargetsMetadata(e, t, n) {
        return this.Bn(e).next((i) => ((i.highestListenSequenceNumber = t), n && (i.lastRemoteSnapshotVersion = n.toTimestamp()), t > i.highestListenSequenceNumber && (i.highestListenSequenceNumber = t), this.Ln(e, i)));
    }
    addTargetData(e, t) {
    ...
    removeTargetData(e, t) {
        return this.removeMatchingKeysForTargetId(e, t.targetId)
            ...
            .next(() => this.Bn(e))
            .next((t) => (__PRIVATE_hardAssert(t.targetCount > 0), (t.targetCount -= 1), this.Ln(e, t)));
    }
    removeTargets(e, t, n) {
        let i = 0;
        const s = [];
...
class __PRIVATE_LruScheduler {
    ...
    Gn(e) {
        __PRIVATE_logDebug("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`),
            (this.Wn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, async () => {
                this.Wn = null;
                try {
...
class __PRIVATE_LruGarbageCollectorImpl {
    ...
    collect(e, t) {
        return -1 === this.params.cacheSizeCollectionThreshold
            ? (__PRIVATE_logDebug("LruGarbageCollector", "Garbage collection skipped; disabled"), PersistencePromise.resolve(vt))
            : this.getCacheSize(e).next((n) =>
                  n < this.params.cacheSizeCollectionThreshold
                      ? (__PRIVATE_logDebug("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), vt)
                      : this.Jn(e, t)
              );
    }
    getCacheSize(e) {
    ...
    Jn(e, t) {
        ...
        return this.calculateTargetCount(e, this.params.percentileToCollect)
            .next(
                (t) => (
                    t > this.params.maximumSequenceNumbersToCollect
                        ? (__PRIVATE_logDebug("LruGarbageCollector", `Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${t}`), (i = this.params.maximumSequenceNumbersToCollect))
                        : (i = t),
                    (o = Date.now()),
            ...
            .next((t) => ((s = t), (_ = Date.now()), this.removeOrphanedDocuments(e, n)))
            .next(
                (e) => (
                    (h = Date.now()),
                    ...
                    PersistencePromise.resolve({ didRun: !0, sequenceNumbersCollected: i, targetsRemoved: s, documentsRemoved: e })
                )
            );
    }
}
...
class __PRIVATE_IndexedDbLruDelegateImpl {
    ...
    Xn(e, t) {
        return (function __PRIVATE_mutationQueuesContainKey(e, t) {
            let n = !1;
            return __PRIVATE_mutationQueuesStore(e)
                .Z((i) => __PRIVATE_mutationQueueContainsKey(e, i, t).next((e) => (e && (n = !0), PersistencePromise.resolve(!e))))
                .next(() => n);
        })(e, t);
    }
    removeOrphanedDocuments(e, t) {
    ...
    Zn(e, t) {
        ...
        return n
            .Y({ index: "documentTargetsIndex" }, ([e, n], { path: o, sequenceNumber: u }) => {
...
function __PRIVATE_writeSentinelKey(e, t) {
    return __PRIVATE_documentTargetStore(e).put(
        (function __PRIVATE_sentinelRow(e, t) {
            return { targetId: 0, path: __PRIVATE_encodeResourcePath(e.path), sequenceNumber: t };
...
class __PRIVATE_IndexedDbRemoteDocumentCacheImpl {
    ...
    getEntry(e, t) {
        ...
        return __PRIVATE_remoteDocumentsStore(e)
            .Y({ index: "documentKeyIndex", range: IDBKeyRange.only(__PRIVATE_dbKey(t)) }, (e, i) => {
                n = this.tr(t, i);
            })
            .next(() => n);
    }
    ...
    getDocumentsMatchingQuery(e, t, n, i, s) {
        ...
        return __PRIVATE_remoteDocumentsStore(e)
            ...
            .next((e) => {
                ...
                let n = __PRIVATE_mutableDocumentMap();
                for (const s of e) {
                    const e = this.tr(DocumentKey.fromSegments(s.prefixPath.concat(s.collectionGroup, s.documentId)), s);
    ...
    getAllFromCollectionGroup(e, t, n, i) {
        ...
        return __PRIVATE_remoteDocumentsStore(e)
            .Y({ index: "collectionGroupIndex", range: IDBKeyRange.bound(o, u, !0) }, (e, t, n) => {
                const o = this.tr(DocumentKey.fromSegments(t.prefixPath.concat(t.collectionGroup, t.documentId)), t);
...
class __PRIVATE_IndexedDbRemoteDocumentChangeBuffer extends RemoteDocumentChangeBuffer {
    ...
    applyChanges(e) {
        ...
        return (
            this.changes.forEach((s, o) => {
                ...
                if ((t.push(this._r.removeEntry(e, s, u.readTime)), o.isValidDocument())) {
                    ...
                    const n = __PRIVATE_toDbRemoteDocument(this._r.serializer, o.convertToNoDocument(SnapshotVersion.min()));
    ...
    getFromCache(e, t) {
        return this._r.nr(e, t).next((e) => (this.ar.set(t, { size: e.size, readTime: e.document.readTime }), e.document));
    }
    getAllFromCache(e, t) {
...
function __PRIVATE_dbKeyComparator(e, t) {
    const n = e.path.toArray(),
        i = t.path.toArray();
    let s = 0;
    for (let e = 0; e < n.length - 2 && e < i.length - 2; ++e) if (((s = __PRIVATE_primitiveComparator(n[e], i[e])), s)) return s;
...
class LocalDocumentsView {
    ...
    getDocument(e, t) {
        ...
        return this.documentOverlayCache
            ...
            .next((e) => (null !== n && __PRIVATE_mutationApplyToLocalView(n.mutation, e, FieldMask.empty(), Timestamp.now()), e));
    }
    getDocuments(e, t) {
    ...
    computeViews(e, t, n, i) {
        ...
        return (
            t.forEach((e, t) => {
                const u = n.get(t.key);
                i.has(t.key) && (void 0 === u || u.mutation instanceof __PRIVATE_PatchMutation)
                    ? (s = s.insert(t.key, t))
                    : void 0 !== u
                    ? (o.set(t.key, u.mutation.getFieldMask()), __PRIVATE_mutationApplyToLocalView(u.mutation, t, u.mutation.getFieldMask(), Timestamp.now()))
        ...
        return this.remoteDocumentCache.getAllFromCollectionGroup(e, t, n, i).next((s) => {
            ...
            return o.next((t) =>
                PersistencePromise.forEach(
                    ...
                    .next((e) => ({ batchId: u, changes: __PRIVATE_convertOverlayedDocumentMapToDocumentMap(e) }))
            );
        });
    }
    ...
    getDocumentsMatchingCollectionQuery(e, t, n, i) {
        ...
        return this.documentOverlayCache
            ...
            .next((o) => ((s = o), this.remoteDocumentCache.getDocumentsMatchingQuery(e, t, n, s, i)))
            .next((e) => {
                s.forEach((t, n) => {
                    const i = n.getKey();
        ...
        return (
            this.ur.set(
                ...
                (function __PRIVATE_fromBundleMetadata(e) {
                    return { id: e.id, version: e.version, createTime: __PRIVATE_fromVersion(e.createTime) };
                })(t)
            ),
            PersistencePromise.resolve()
        );
        ...
        return (
            this.cr.set(
                ...
                (function __PRIVATE_fromProtoNamedQuery(e) {
                    return { name: e.name, query: __PRIVATE_fromBundledQuery(e.bundledQuery), readTime: __PRIVATE_fromVersion(e.readTime) };
                })(t)
            ),
            PersistencePromise.resolve()
        );
...
class __PRIVATE_MemoryDocumentOverlayCache {
    ...
    removeOverlaysForBatchId(e, t, n) {
        ...
        return void 0 !== i && (i.forEach((e) => (this.overlays = this.overlays.remove(e))), this.lr.delete(n)), PersistencePromise.resolve();
    }
    getOverlaysForCollection(e, t, n) {
        const i = __PRIVATE_newOverlayMap(),
            s = t.length + 1,
    ...
    lt(e, t, n) {
        ...
        let s = this.lr.get(t);
        void 0 === s && ((s = __PRIVATE_documentKeySet()), this.lr.set(t, s)), this.lr.set(t, s.add(n.key));
    }
}
...
class __PRIVATE_MemoryMutationQueue {
    ...
    addMutationBatch(e, t, n, i) {
        ...
        for (const t of i) (this.yr = this.yr.add(new __PRIVATE_DocReference(t.key, s))), this.indexManager.addToCollectionParentIndex(e, t.key.path.popLast());
...
class __PRIVATE_MemoryRemoteDocumentCacheImpl {
    ...
    addEntry(e, t) {
        const n = t.key,
            ...
            s = i ? i.size : 0,
            o = this.Cr(t);
        return (this.docs = this.docs.insert(n, { document: t.mutableCopy(), size: o })), (this.size += o - s), this.indexManager.addToCollectionParentIndex(e, n.path.popLast());
    }
    removeEntry(e) {
    ...
    applyChanges(e) {
        ...
        return (
            this.changes.forEach((n, i) => {
                i.isValidDocument() ? t.push(this._r.addEntry(e, i)) : this._r.removeEntry(n);
            }),
            PersistencePromise.waitFor(t)
        );
    }
...
class __PRIVATE_MemoryTargetCache {
    ...
    removeTargets(e, t, n) {
        ...
        return (
            this.Fr.forEach((o, u) => {
                u.sequenceNumber <= t && null === n.get(u.targetId) && (this.Fr.delete(o), s.push(this.removeMatchingKeysForTargetId(e, u.targetId)), i++);
            }),
...
class __PRIVATE_MemoryPersistence {
    constructor(e, t) {
        (this.Br = {}),
            ...
            (this.remoteDocumentCache = (function __PRIVATE_newMemoryRemoteDocumentCache(e) {
...
class __PRIVATE_MemoryLruDelegate {
    ...
    Hn(e, t) {
        return PersistencePromise.forEach(this.Yr, (n, i) => this.Xn(e, n, i).next((e) => (e ? PersistencePromise.resolve() : t(i))));
    }
    removeTargets(e, t, n) {
...
class __PRIVATE_SchemaConverter {
        ...
        n < 1 &&
            ...
            (function __PRIVATE_createMutationQueue(e) {
                e.createObjectStore("mutationQueues", { keyPath: "userId" }),
                    e.createObjectStore("mutations", { keyPath: "batchId", autoIncrement: !0 }).createIndex("userMutationsIndex", Ge, { unique: !0 }),
                ...
                (o = o.next(() =>
                    (function __PRIVATE_writeEmptyTargetGlobalEntry(e) {
                        const t = e.store("targetGlobal"),
                            n = { highestTargetId: 0, highestListenSequenceNumber: 0, lastRemoteSnapshotVersion: SnapshotVersion.min().toTimestamp(), targetCount: 0 };
                    ...
                    (o = o.next(() =>
                        (function __PRIVATE_upgradeMutationBatchSchemaAndMigrateData(e, t) {
                            return t
                                ...
                                .W()
                                .next((n) => {
                                    e.deleteObjectStore("mutations"), e.createObjectStore("mutations", { keyPath: "batchId", autoIncrement: !0 }).createIndex("userMutationsIndex", Ge, { unique: !0 });
            ...
            n < 12 &&
                ...
                (o = o.next(() => {
                    !(function __PRIVATE_createDocumentOverlayStore(e) {
                        ...
                        t.createIndex("collectionPathOverlayIndex", st, { unique: !1 }), t.createIndex("collectionGroupOverlayIndex", ot, { unique: !1 });
                    })(e);
                })),
            n < 13 &&
                i >= 13 &&
                (o = o
                    .next(() =>
                        (function __PRIVATE_createRemoteDocumentCache(e) {
                            const t = e.createObjectStore("remoteDocumentsV14", { keyPath: We });
                            t.createIndex("documentKeyIndex", je), t.createIndex("collectionGroupIndex", He);
                        })(e)
                    )
                    .next(() => this.ri(e, s))
            ...
            n < 15 &&
                ...
                (o = o.next(() =>
                    (function __PRIVATE_createFieldIndex(e) {
                        e.createObjectStore("indexConfiguration", { keyPath: "indexId", autoIncrement: !0 }).createIndex("collectionGroupIndex", "collectionGroup", { unique: !1 }),
                            e.createObjectStore("indexState", { keyPath: et }).createIndex("sequenceNumberIndex", tt, { unique: !1 }),
                            e.createObjectStore("indexEntries", { keyPath: nt }).createIndex("documentKeyIndex", rt, { unique: !1 });
                    })(e)
                )),
            o
        );
            ...
            .next((e) => {
                ...
                return n
                    .Y((n, s) => {
                        ...
                        i.push(t.get(u).next((n) => (n ? PersistencePromise.resolve() : ((n) => t.put({ targetId: 0, path: __PRIVATE_encodeResourcePath(n), sequenceNumber: e.highestListenSequenceNumber }))(o))));
                    })
                    .next(() => PersistencePromise.waitFor(i));
            });
    }
        ...
        const n = t.store("collectionParents"),
            ...
            addEntry = (e) => {
                if (i.add(e)) {
                    const t = e.lastSegment(),
                        i = e.popLast();
                    return n.put({ collectionId: t, parent: __PRIVATE_encodeResourcePath(i) });
                }
            };
        return t
            .store("remoteDocuments")
            ...
            .Y((e, n) => {
                const s = t.store("remoteDocumentsV14"),
                    o = (function __PRIVATE_extractKey(e) {
                        return e.document
                            ? new DocumentKey(ResourcePath.fromString(e.document.name).popFirst(5))
                            : e.noDocument
    ...
    ii(e, t) {
        const n = t.store("mutations"),
            ...
            s = new __PRIVATE_MemoryPersistence(__PRIVATE_MemoryEagerDelegate.jr, this.serializer.ut);
        return n.W().next((e) => {
            const n = new Map();
            return (
                e.forEach((e) => {
                ...
                PersistencePromise.forEach(n, (e, n) => {
                    const o = new User(n),
                        ...
                        _ = __PRIVATE_IndexedDbMutationQueue.ct(o, this.serializer, l, s.referenceDelegate);
...
function __PRIVATE_createQueryCache(e) {
    e.createObjectStore("targetDocuments", { keyPath: Je }).createIndex("documentTargetsIndex", Xe, { unique: !0 }),
        e.createObjectStore("targets", { keyPath: "targetId" }).createIndex("queryTargetsIndex", Ye, { unique: !0 }),
...
class __PRIVATE_IndexedDbPersistence {
    constructor(e, t, n, i, s, o, u, l, _, h, d = 15) {
        if (
            ...
            throw new FirestoreError($e.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        (this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, i)),
            (this.Ii = t + "main"),
            (this.serializer = new __PRIVATE_LocalSerializer(l)),
            (this.Ti = new __PRIVATE_SimpleDb(this.Ii, this.ai, new __PRIVATE_SchemaConverter(this.serializer))),
    ...
    di() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (e) =>
            __PRIVATE_clientMetadataStore(e)
                ...
                .next(() => this.gi(e))
                .next((t) => (this.isPrimary && !t ? this.pi(e).next(() => !1) : !!t && this.yi(e).next(() => !0)))
        )
            .catch((e) => {
    ...
    runTransaction(e, t, n) {
        ...
        return this.Ti.runTransaction(
            ...
            s,
            (i) => (
                (o = new __PRIVATE_IndexedDbTransaction(i, this.Lr ? this.Lr.next() : __PRIVATE_ListenSequence._e)),
                "readwrite-primary" === t
                    ? this.fi(o)
                          .next((e) => !!e || this.gi(o))
                          .next((t) => {
                              if (!t) throw (__PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), (this.isPrimary = !1), this.si.enqueueRetryable(() => this.Pi(!1)), new FirestoreError($e.FAILED_PRECONDITION, Ke));
                              return n(o);
                          })
    ...
    Li(e) {
        return __PRIVATE_primaryClientStore(e)
            .get("owner")
            .next((e) => {
                if (null !== e && this.Di(e.leaseTimestampMs, 5e3) && !this.Fi(e.ownerId) && !this.wi(e) && !(this._i || (this.allowTabSynchronization && e.allowTabSynchronization))) throw new FirestoreError($e.FAILED_PRECONDITION, wt);
            });
    }
    yi(e) {
    ...
    Ri() {
        ...
        "function" == typeof (null === (e = this.window) || void 0 === e ? void 0 : e.addEventListener) &&
            ((this.ui = () => {
                ...
                isSafari() && (navigator.appVersion.match(e) || navigator.userAgent.match(e)) && this.si.enterRestrictedMode(!0), this.si.enqueueAndForget(() => this.shutdown());
            }),
...
class __PRIVATE_QueryEngine {
    ...
    Ji(e, t, n, i) {
        return n.documentReadCount < this.Ui
            ? (__PRIVATE_getLogLevel() <= l.DEBUG &&
                  __PRIVATE_logDebug("QueryEngine", "SDK will not create cache indexes for query:", __PRIVATE_stringifyQuery(t), "since it only creates cache indexes for collection contains", "more than or equal to", this.Ui, "documents"),
              PersistencePromise.resolve())
            : (__PRIVATE_getLogLevel() <= l.DEBUG && __PRIVATE_logDebug("QueryEngine", "Query:", __PRIVATE_stringifyQuery(t), "scans", n.documentReadCount, "local documents and returns", i, "documents as results."),
              n.documentReadCount > this.Wi * i
                  ? (__PRIVATE_getLogLevel() <= l.DEBUG && __PRIVATE_logDebug("QueryEngine", "The SDK decides to create cache indexes for query:", __PRIVATE_stringifyQuery(t), "as using cache indexes may help improve performance."),
                    this.indexManager.createTargetIndexes(e, __PRIVATE_queryToTarget(t)))
                  : PersistencePromise.resolve());
    }
    zi(e, t) {
        ...
        return this.indexManager.getIndexType(e, n).next((i) =>
            0 === i
                ? null
                : (null !== t.limit && 1 === i && ((t = __PRIVATE_queryWithLimit(t, null, "F")), (n = __PRIVATE_queryToTarget(t))),
                  this.indexManager.getDocumentsMatchingTarget(e, n).next((i) => {
                      ...
                      return this.Gi.getDocuments(e, s).next((i) =>
                          this.indexManager.getMinOffset(e, n).next((n) => {
                              const o = this.Yi(t, i);
                              return this.Zi(t, o, s, n.readTime) ? this.zi(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.Xi(e, o, t, n);
                          })
                      );
                  }))
        );
    ...
    ji(e, t, n, i) {
        return __PRIVATE_queryMatchesAllDocuments(t) || i.isEqual(SnapshotVersion.min())
            ? PersistencePromise.resolve(null)
            : this.Gi.getDocuments(e, n).next((s) => {
                  const o = this.Yi(t, s);
                  return this.Zi(t, o, n, i)
                      ? PersistencePromise.resolve(null)
                      : (__PRIVATE_getLogLevel() <= l.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", i.toString(), __PRIVATE_stringifyQuery(t)),
                        this.Xi(e, o, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(i, -1)).next((e) => e));
              });
    }
    Yi(e, t) {
    ...
    Hi(e, t, n) {
        return __PRIVATE_getLogLevel() <= l.DEBUG && __PRIVATE_logDebug("QueryEngine", "Using full collection scan to execute query:", __PRIVATE_stringifyQuery(t)), this.Gi.getDocumentsMatchingQuery(e, t, IndexOffset.min(), n);
    }
    Xi(e, t, n, i) {
...
class __PRIVATE_LocalStoreImpl {
    ...
    os(e) {
        (this.documentOverlayCache = this.persistence.getDocumentOverlayCache(e)),
            ...
            (this.localDocuments = new LocalDocumentsView(this.ss, this.mutationQueue, this.documentOverlayCache, this.indexManager)),
...
async function __PRIVATE_localStoreHandleUserChange(e, t) {
    ...
    return await n.persistence.runTransaction("Handle user change", "readonly", (e) => {
        ...
        return n.mutationQueue
            .getAllMutationBatches(e)
            .next((s) => ((i = s), n.os(t), n.mutationQueue.getAllMutationBatches(e)))
            .next((t) => {
                const s = [],
                    o = [];
                ...
                return n.localDocuments.getDocuments(e, u).next((e) => ({ _s: e, removedBatchIds: s, addedBatchIds: o }));
            });
    });
}
                ...
                n.forEach((n, o) => {
                    ...
                    o.isFoundDocument() !== u.isFoundDocument() && (s = s.add(n)),
                        o.isNoDocument() && o.version.isEqual(SnapshotVersion.min())
                            ...
                            : !u.isValidDocument() || o.version.compareTo(u.version) > 0 || (0 === o.version.compareTo(u.version) && u.hasPendingWrites)
                            ? (t.addEntry(o), (i = i.insert(n, o)))
                            : __PRIVATE_logDebug("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", u.version, " Watch version:", o.version);
                }),
                { us: i, cs: s }
            );
        })
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
    ...
    return n.persistence
        .runTransaction("Allocate target", "readwrite", (e) => {
            ...
            return n.qr
                .getTargetData(e, t)
                .next((s) => (s ? ((i = s), PersistencePromise.resolve(i)) : n.qr.allocateTargetId(e).next((s) => ((i = new TargetData(t, s, "TargetPurposeListen", e.currentSequenceNumber)), n.qr.addTargetData(e, i).next(() => i)))));
        })
        .then((e) => {
            const i = n.ts.get(e.targetId);
            return (null === i || e.snapshotVersion.compareTo(i.snapshotVersion) > 0) && ((n.ts = n.ts.insert(e.targetId, e)), n.ns.set(t, e.targetId)), e;
        });
}
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
    ...
    return i.persistence.runTransaction("Execute query", "readwrite", (e) =>
        (function __PRIVATE_localStoreGetTargetData(e, t, n) {
            const i = __PRIVATE_debugCast(e),
                s = i.ns.get(n);
            return void 0 !== s ? PersistencePromise.resolve(i.ts.get(s)) : i.qr.getTargetData(t, n);
            ...
            .next(() => i.es.getDocumentsMatchingQuery(e, t, n ? s : SnapshotVersion.min(), n ? o : __PRIVATE_documentKeySet()))
            .next((e) => (__PRIVATE_setMaxReadTime(i, __PRIVATE_queryCollectionGroup(t), e), { documents: e, ls: o }))
    );
}
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
    ...
    return n.persistence
        .runTransaction("Get new document changes", "readonly", (e) => n.ss.getAllFromCollectionGroup(e, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(i, -1), Number.MAX_SAFE_INTEGER))
...
class __PRIVATE_MutationMetadata {
    ...
    static Ts(e, t, n) {
        ...
        return (
            o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code), o && (s = new FirestoreError(i.error.code, i.error.message))),
            o ? new __PRIVATE_MutationMetadata(e, t, i.state, s) : (__PRIVATE_logError("SharedClientState", `Failed to parse mutation state for ID '${t}': ${n}`), null)
        );
    }
    Es() {
...
class __PRIVATE_QueryTargetMetadata {
    ...
    static Ts(e, t) {
        ...
        let i,
            s = "object" == typeof n && -1 !== ["not-current", "current", "rejected"].indexOf(n.state) && (void 0 === n.error || "object" == typeof n.error);
        return (
            s && n.error && ((s = "string" == typeof n.error.message && "string" == typeof n.error.code), s && (i = new FirestoreError(n.error.code, n.error.message))),
            s ? new __PRIVATE_QueryTargetMetadata(e, n.state, i) : (__PRIVATE_logError("SharedClientState", `Failed to parse target state for ID '${e}': ${t}`), null)
        );
    }
    Es() {
        const e = { state: this.state, updateTimeMs: Date.now() };
...
class __PRIVATE_SharedOnlineState {
    ...
    static Ts(e) {
        ...
        return "object" == typeof t && -1 !== ["Unknown", "Online", "Offline"].indexOf(t.onlineState) && "string" == typeof t.clientId
            ...
            : (__PRIVATE_logError("SharedClientState", `Failed to parse online state: ${e}`), null);
    }
}
...
class __PRIVATE_WebStorageSharedClientState {
    ...
    async start() {
        ...
        (this.ps = []), this.window.addEventListener("pagehide", () => this.shutdown()), (this.started = !0);
    }
...
class __PRIVATE_WebChannelConnection extends class __PRIVATE_RestConnection {
    constructor(e) {
        ...
        (this.mo = t + "://" + e.host), (this.fo = `projects/${n}/databases/${i}`), (this.po = "(default)" === this.databaseId.database ? `project_id=${n}` : `project_id=${n}&database_id=${i}`);
    }
    get yo() {
        return !1;
    }
    wo(e, t, n, i, s) {
        ...
        const l = { "google-cloud-resource-prefix": this.fo, "x-goog-request-params": this.po };
        return (
            this.bo(l, i, s),
            this.Do(e, u, l, n).then(
                (t) => (__PRIVATE_logDebug("RestConnection", `Received RPC '${e}' ${o}: `, t), t),
                (t) => {
    ...
    vo(e, t, n) {
        ...
        void 0 !== _ && (l.longPollingTimeout = Math.round(1e3 * _)), this.useFetchStreams && (l.useFetchStreams = !0), this.bo(l.initMessageHeaders, t, n), (l.encodeInitMessageHeaders = !0);
        const h = s.join("");
        ...
        const g = new __PRIVATE_StreamBridge({
                co: (t) => {
                    f
                        ? __PRIVATE_logDebug(Ft, `Not sending because RPC '${e}' stream ${i} is closed:`, t)
                        : (m || (__PRIVATE_logDebug(Ft, `Opening RPC '${e}' stream ${i} transport.`), d.open(), (m = !0)), __PRIVATE_logDebug(Ft, `RPC '${e}' stream ${i} sending:`, t), d.send(t));
                },
                lo: () => d.close(),
            }),
        ...
        return (
            ...
            __PRIVATE_unguardedEventListen(d, Me.EventType.CLOSE, () => {
                f || ((f = !0), __PRIVATE_logDebug(Ft, `RPC '${e}' stream ${i} transport closed`), g.Ro());
            }),
            __PRIVATE_unguardedEventListen(d, Me.EventType.ERROR, (t) => {
                f || ((f = !0), __PRIVATE_logWarn(Ft, `RPC '${e}' stream ${i} transport errored:`, t), g.Ro(new FirestoreError($e.UNAVAILABLE, "The operation could not be completed")));
            }),
                ...
                if (!f) {
                    ...
                    if (u) {
                        ...
                        let n = (function __PRIVATE_mapCodeFromRpcStatus(e) {
                            ...
                            s = u.message;
                        void 0 === n && ((n = $e.INTERNAL), (s = "Unknown error status: " + t + " with message " + u.message)), (f = !0), g.Ro(new FirestoreError(n, s)), d.close();
                    } else __PRIVATE_logDebug(Ft, `RPC '${e}' stream ${i} received:`, s), g.Vo(s);
                }
            }),
...
class __PRIVATE_ExponentialBackoff {
    constructor(e, t, n = 1e3, i = 1.5, s = 6e4) {
        (this.si = e), (this.timerId = t), (this.Fo = n), (this.Mo = i), (this.xo = s), (this.Oo = 0), (this.No = null), (this.Bo = Date.now()), this.reset();
    }
    reset() {
        this.Oo = 0;
    }
    ...
    ko(e) {
        ...
        const t = Math.floor(this.Oo + this.qo()),
            ...
            i = Math.max(0, t - n);
        i > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${i} ms (base delay: ${this.Oo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`),
            (this.No = this.si.enqueueAfterDelay(this.timerId, i, () => ((this.Bo = Date.now()), e()))),
            (this.Oo *= this.Mo),
    ...
    async close(e, t) {
        this.t_(),
            ...
            4 !== e
                ...
                : t && t.code === $e.UNAUTHENTICATED && 3 !== this.state && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()),
                    ...
                    const i = (function __PRIVATE_fromWatchTargetChangeState(e) {
                        ...
                        o = (function __PRIVATE_fromBytes(e, t) {
                            return e.useProto3Json
                                ? (__PRIVATE_hardAssert(void 0 === t || "string" == typeof t), ByteString.fromBase64String(t || ""))
                                : (__PRIVATE_hardAssert(void 0 === t || t instanceof Uint8Array), ByteString.fromUint8Array(t || new Uint8Array()));
    ...
    u_(e) {
        ...
        (t.database = __PRIVATE_getEncodedDatabaseId(this.serializer)),
            (t.addTarget = (function __PRIVATE_toTarget(e, t) {
                let n;
                const i = t.target;
                if (((n = __PRIVATE_targetIsDocumentTarget(i) ? { documents: __PRIVATE_toDocumentsTarget(e, i) } : { query: __PRIVATE_toQueryTarget(e, i) }), (n.targetId = t.targetId), t.resumeToken.approximateByteSize() > 0)) {
...
class __PRIVATE_PersistentWriteStream extends __PRIVATE_PersistentStream {
    constructor(e, t, n, i, s, o) {
        super(e, "write_stream_connection_backoff", "write_stream_idle", "health_check_timeout", t, n, i, o), (this.serializer = s), (this.l_ = !1);
    }
    get h_() {
        return this.l_;
    }
    ...
    P_(e) {
        const t = { streamToken: this.lastStreamToken, writes: e.map((e) => toMutation(this.serializer, e)) };
        this.e_(t);
    }
}
class __PRIVATE_DatastoreImpl extends class Datastore {} {
    constructor(e, t, n, i) {
        super(), (this.authCredentials = e), (this.appCheckCredentials = t), (this.connection = n), (this.serializer = i), (this.d_ = !1);
    }
    A_() {
        if (this.d_) throw new FirestoreError($e.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    wo(e, t, n) {
        return (
            this.A_(),
...
class __PRIVATE_OnlineStateTracker {
    ...
    g_() {
        0 === this.V_ &&
            (this.p_("Unknown"), (this.m_ = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => ((this.m_ = null), this.y_("Backend didn't respond within 10 seconds."), this.p_("Offline"), Promise.resolve()))));
    }
    w_(e) {
            ...
            this.F_.ro((e) => {
                n.enqueueAndForget(async () => {
                    __PRIVATE_canUseNetwork(this) &&
                        (__PRIVATE_logDebug("RemoteStore", "Restarting streams for network reachability change."),
                        await (async function __PRIVATE_restartNetwork(e) {
                            const t = __PRIVATE_debugCast(e);
                            t.C_.add(4), await __PRIVATE_disableNetworkInternal(t), t.M_.set("Unknown"), t.C_.delete(4), await __PRIVATE_enableNetworkInternal(t);
                        })(this));
                });
            }),
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
    ...
    n.D_.delete(t), i.Ho() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.D_.size && (i.Ho() ? i.Zo() : __PRIVATE_canUseNetwork(n) && n.M_.set("Unknown"));
}
...
function __PRIVATE_startWatchStream(e) {
    (e.x_ = new __PRIVATE_WatchChangeAggregator({ getRemoteKeysForTarget: (t) => e.remoteSyncer.getRemoteKeysForTarget(t), _t: (t) => e.D_.get(t) || null, nt: () => e.datastore.serializer.databaseId })),
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
    if ((e.M_.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause))
        try {
            await (async function __PRIVATE_handleTargetError(e, t) {
                const n = t.cause;
                for (const i of t.targetIds) e.D_.has(i) && (await e.remoteSyncer.rejectListen(i, n), e.D_.delete(i), e.x_.removeTarget(i));
            })(e, t);
        } catch (n) {
                ...
                (await (function __PRIVATE_raiseWatchSnapshot(e, t) {
                    ...
                    return (
                        ...
                        n.targetMismatches.forEach((t, n) => {
                            const i = e.D_.get(t);
                            if (!i) return;
                            e.D_.set(t, i.withResumeToken(ByteString.EMPTY_BYTE_STRING, i.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e, t);
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
    ...
    e.C_.add(1),
        ...
        e.M_.set("Offline"),
        n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)),
    ...
    t &&
        ...
        (await (async function __PRIVATE_handleWriteError(e, t) {
            if (
                ...
                const n = e.b_.shift();
                __PRIVATE_ensureWriteStream(e).Yo(), await __PRIVATE_executeWithRecovery(e, () => e.remoteSyncer.rejectFailedWrite(n.batchId, t)), await __PRIVATE_fillWritePipeline(e);
            }
        })(e, t)),
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
    ...
    n.C_.add(3), await __PRIVATE_disableNetworkInternal(n), i && n.M_.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.C_.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
    ...
    return (
        e.O_ ||
            ((e.O_ = (function __PRIVATE_newPersistentWatchStream(e, t, n) {
                const i = __PRIVATE_debugCast(e);
                return i.A_(), new __PRIVATE_PersistentListenStream(t, i.connection, i.authCredentials, i.appCheckCredentials, i.serializer, n);
            })(e.datastore, e.asyncQueue, { ho: __PRIVATE_onWatchStreamOpen.bind(null, e), Io: __PRIVATE_onWatchStreamClose.bind(null, e), a_: __PRIVATE_onWatchStreamChange.bind(null, e) })),
            e.v_.push(async (t) => {
    ...
    return (
        e.N_ ||
            ((e.N_ = (function __PRIVATE_newPersistentWriteStream(e, t, n) {
                const i = __PRIVATE_debugCast(e);
                return i.A_(), new __PRIVATE_PersistentWriteStream(t, i.connection, i.authCredentials, i.appCheckCredentials, i.serializer, n);
...
class __PRIVATE_EventManagerImpl {
    constructor() {
        (this.queries = new ObjectMap((e) => __PRIVATE_canonifyQuery(e), __PRIVATE_queryEquals)), (this.onlineState = "Unknown"), (this.q_ = new Set());
    }
}
async function __PRIVATE_eventManagerListen(e, t) {
    ...
    n.queries.set(i, o), o.listeners.push(t), t.Q_(n.onlineState), o.k_ && t.K_(o.k_) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
}
...
class __PRIVATE_BundleLoader {
    constructor(e, t, n) {
        (this.X_ = e), (this.localStore = t), (this.serializer = n), (this.queries = []), (this.documents = []), (this.collectionGroups = new Set()), (this.progress = __PRIVATE_bundleInitialProgress(e));
    }
    ea(e) {
        ...
        if (e.Y_.namedQuery) this.queries.push(e.Y_.namedQuery);
            ...
            this.documents.push({ metadata: e.Y_.documentMetadata }), e.Y_.documentMetadata.exists || ++t;
    ...
    async complete() {
        const e = await (async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, i) {
                ...
                return s.persistence.runTransaction("Apply bundle documents", "readwrite", (e) =>
                    __PRIVATE_populateDocumentChangeBuffer(e, l, u)
                        ...
                        .next((t) =>
                            s.qr
                                ...
                                .next(() => s.localDocuments.getLocalViewOfDocuments(e, t.us, t.cs))
                                .next(() => t.us)
                        )
                );
            })(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.X_.id),
        ...
        return (this.progress.taskState = "Success"), { progress: this.progress, na: this.collectionGroups, ra: e };
    }
}
...
class __PRIVATE_View {
            ...
            (e.inorderTraversal((e, t) => {
                ...
                h && d
                    ? h.data.isEqual(d.data)
                        ...
                        : this.ha(h, d) || (n.track({ type: 2, doc: d }), (g = !0), ((l && this._a(d, l) > 0) || (_ && this._a(d, _) < 0)) && (u = !0))
                    : !h && d
                    ? (n.track({ type: 0, doc: d }), (g = !0))
                    : h && !d && (n.track({ type: 1, doc: h }), (g = !0), (l || _) && (u = !0)),
                    g && (d ? ((o = o.add(d)), (s = f ? s.add(e) : s.delete(e))) : ((o = o.delete(e)), (s = s.delete(e))));
            }),
            null !== this.query.limit)
        )
            for (; o.size > this.query.limit; ) {
                const e = "F" === this.query.limitType ? o.last() : o.first();
                (o = o.delete(e.key)), (s = s.delete(e.key)), n.track({ type: 1, doc: e });
            }
    ...
    applyChanges(e, t, n, i) {
        ...
        const u = t && !i ? this.Ia() : [],
            ...
            _ = l !== this.sa;
        return (this.sa = l), 0 !== o.length || _ ? { snapshot: new ViewSnapshot(this.query, e.aa, s, o, e.mutatedKeys, 0 === l, _, !1, !!n && n.resumeToken.approximateByteSize() > 0), Ta: u } : { Ta: u };
    }
    Q_(e) {
        return this.current && "Offline" === e ? ((this.current = !1), this.applyChanges({ aa: this.aa, la: new __PRIVATE_DocumentChangeSet(), mutatedKeys: this.mutatedKeys, Zi: !1 }, !1)) : { Ta: [] };
    }
    Ea(e) {
...
class __PRIVATE_SyncEngineImpl {
    constructor(e, t, n, i, s, o) {
        (this.localStore = e),
            ...
            (this.Va = {}),
            (this.ma = new ObjectMap((e) => __PRIVATE_canonifyQuery(e), __PRIVATE_queryEquals)),
            (this.fa = new Map()),
            (this.ga = new Set()),
...
async function __PRIVATE_syncEngineListen(e, t) {
    ...
    let i, s;
    const o = n.ma.get(t);
    if (o) (i = o.targetId), n.sharedClientState.addLocalQueryTarget(i), (s = o.view.Aa());
    else {
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, i, s) {
    e.va = (t, n, i) =>
        (async function __PRIVATE_applyDocChanges(e, t, n, i) {
            let s = t.view.ca(n);
            s.Zi && (s = await __PRIVATE_localStoreExecuteQuery(e.localStore, t.query, !1).then(({ documents: e }) => t.view.ca(e, s)));
    ...
    return e.ma.set(t, d), e.fa.has(n) ? e.fa.get(n).push(t) : e.fa.set(n, [t]), h.snapshot;
}
async function __PRIVATE_syncEngineUnlisten(e, t) {
    ...
    n.isPrimaryClient
        ...
        : (__PRIVATE_removeAndCleanupTarget(n, i.targetId), await __PRIVATE_localStoreReleaseTarget(n.localStore, i.targetId, !0));
}
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
    const n = __PRIVATE_debugCast(e);
    try {
        const e = await (function __PRIVATE_localStoreApplyRemoteEventToLocalCache(e, t) {
            const n = __PRIVATE_debugCast(e),
                i = t.snapshotVersion;
            let s = n.ts;
            return n.persistence
                .runTransaction("Apply remote event", "readwrite-primary", (e) => {
                    ...
                    t.targetChanges.forEach((o, l) => {
                        ...
                        null !== t.targetMismatches.get(l)
                            ? (h = h.withResumeToken(ByteString.EMPTY_BYTE_STRING, SnapshotVersion.min()).withLastLimboFreeSnapshotVersion(SnapshotVersion.min()))
                            : o.resumeToken.approximateByteSize() > 0 && (h = h.withResumeToken(o.resumeToken, i)),
                            (s = s.insert(l, h)),
                    ...
                    if (
                        ...
                        u.push(
                            __PRIVATE_populateDocumentChangeBuffer(e, o, t.documentUpdates).next((e) => {
                                (l = e.us), (_ = e.cs);
                            })
                        ),
        ...
        t.targetChanges.forEach((e, t) => {
            ...
            i &&
                ...
                e.addedDocuments.size > 0 ? (i.Ra = !0) : e.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(i.Ra) : e.removedDocuments.size > 0 && (__PRIVATE_hardAssert(i.Ra), (i.Ra = !1)));
        }),
...
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
    ...
    if (o) {
        ...
        await __PRIVATE_syncEngineApplyRemoteEvent(i, s), (i.pa = i.pa.remove(o)), i.ya.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(i);
    } else
        ...
        const e = await (function __PRIVATE_localStoreAcknowledgeBatch(e, t) {
            ...
            return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (e) => {
                ...
                return (function __PRIVATE_applyWriteToRemoteDocuments(e, t, n, i) {
                    ...
                    .next(() => n.documentOverlayCache.removeOverlaysForBatchId(e, i, t.batch.batchId))
                    .next(() =>
    ...
    try {
        const e = await (function __PRIVATE_localStoreRejectBatch(e, t) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (e) => {
                ...
                return n.mutationQueue
                    .lookupMutationBatch(e, t)
                    .next((t) => (__PRIVATE_hardAssert(null !== t), (i = t.keys()), n.mutationQueue.removeMutationBatch(e, t)))
                    .next(() => n.mutationQueue.performConsistencyCheck(e))
                    .next(() => n.documentOverlayCache.removeOverlaysForBatchId(e, i, t))
                    .next(() => n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e, i))
                    .next(() => n.localDocuments.getDocuments(e, i));
            });
        })(i.localStore, t);
...
function __PRIVATE_processUserCallback(e, t, n) {
    ...
    if (s) {
        const e = s.get(t);
        e && (n ? e.reject(n) : e.resolve(), (s = s.remove(t))), (i.Sa[i.currentUser.toKey()] = s);
    }
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
    for (const i of n)
        i instanceof __PRIVATE_AddedLimboDocument
            ...
            ? (__PRIVATE_logDebug("SyncEngine", "Document no longer in limbo: " + i.key), e.wa.removeReference(i.key, t), e.wa.containsKey(i.key) || __PRIVATE_removeLimboTarget(e, i.key))
            : fail();
}
function __PRIVATE_trackLimboChange(e, t) {
    const n = t.key,
        i = n.path.canonicalString();
    e.pa.get(n) || e.ga.has(i) || (__PRIVATE_logDebug("SyncEngine", "New document in limbo: " + n), e.ga.add(i), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
    for (; e.ga.size > 0 && e.pa.size < e.maxConcurrentLimboResolutions; ) {
        ...
        e.ya.set(i, new LimboResolution(n)),
            ...
            __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), i, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence._e));
    }
}
        ...
        await (async function __PRIVATE_localStoreNotifyLocalViewChanges(e, t) {
            ...
            try {
                await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (e) =>
                    PersistencePromise.forEach(t, (t) =>
                        PersistencePromise.forEach(t.ki, (i) => n.persistence.referenceDelegate.addReference(e, t.targetId, i)).next(() =>
                            PersistencePromise.forEach(t.qi, (i) => n.persistence.referenceDelegate.removeReference(e, t.targetId, i))
                        )
                    )
                );
            } catch (e) {
...
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
    const n = __PRIVATE_debugCast(e),
        ...
        s = t.view.da(i);
    return n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, s.Ta), s;
}
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, i) {
    const s = __PRIVATE_debugCast(e),
        o = await (function __PRIVATE_localStoreLookupMutationDocuments(e, t) {
            ...
            return n.persistence.runTransaction("Lookup mutation documents", "readonly", (e) => i.Cn(e, t).next((t) => (t ? n.localDocuments.getDocuments(e, t) : PersistencePromise.resolve(null))));
        })(s.localStore, t);
    null !== o
        ? ("pending" === n
...
async function __PRIVATE_syncEngineApplyTargetState(e, t, n, i) {
    const s = __PRIVATE_debugCast(e);
    if (s.Ca) return void __PRIVATE_logDebug("SyncEngine", "Ignoring unexpected query state notification.");
    const o = s.fa.get(t);
    if (o && o.length > 0)
        switch (n) {
            case "current":
...
function __PRIVATE_ensureWatchCallbacks(e) {
    const t = __PRIVATE_debugCast(e);
    return (
        (t.remoteStore.remoteSyncer.applyRemoteEvent = __PRIVATE_syncEngineApplyRemoteEvent.bind(null, t)),
    ...
    async initialize(e) {
        await super.initialize(e),
            ...
            await this.persistence.mi(
                () => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve())
            );
    }
    createLocalStore(e) {
        return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
...
class __PRIVATE_MultiTabOfflineComponentProvider extends __PRIVATE_IndexedDbOfflineComponentProvider {
    constructor(e, t) {
        super(e, t, !1), (this.xa = e), (this.cacheSizeBytes = t), (this.synchronizeTabs = !0);
    }
    async initialize(e) {
        await super.initialize(e);
            ...
            await this.persistence.mi(async (e) => {
                await (async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
                    ...
                    if ((__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), !0 === t && !0 !== n.Ca)) {
                        ...
                        n.fa.forEach((i, s) => {
                            n.sharedClientState.isLocalQueryTarget(s) ? e.push(s) : (t = t.then(() => (__PRIVATE_removeAndCleanupTarget(n, s), __PRIVATE_localStoreReleaseTarget(n.localStore, s, !0)))),
...
class OnlineComponentProvider {
    async initialize(e, t) {
        this.localStore ||
            ...
            (this.sharedClientState.onlineStateHandler = (e) => __PRIVATE_syncEngineApplyOnlineStateChange(this.syncEngine, e, 1)),
...
class __PRIVATE_BundleReaderImpl {
    ...
    async Ka(e) {
        for (; this.buffer.length < e; ) (await this.Ua()) && this.Qa("Reached the end of bundle when more is expected.");
...
class Transaction$2 {
    ...
    async lookup(e) {
        if ((this.ensureCommitNotCalled(), this.mutations.length > 0)) throw new FirestoreError($e.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
...
class __PRIVATE_TransactionRunner {
    constructor(e, t, n, i, s) {
        (this.asyncQueue = e), (this.datastore = t), (this.options = n), (this.updateFunction = i), (this.deferred = s), (this.Wa = n.maxAttempts), (this.zo = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry"));
    }
    run() {
        (this.Wa -= 1), this.Ga();
    }
    ...
    return (
        e._onlineComponents ||
            (e._uninitializedComponentsProvider
                ? (__PRIVATE_logDebug("FirestoreClient", "Using user provided OnlineComponentProvider"), await __PRIVATE_setOnlineComponentProvider(e, e._uninitializedComponentsProvider._online))
                : (__PRIVATE_logDebug("FirestoreClient", "Using default OnlineComponentProvider"), await __PRIVATE_setOnlineComponentProvider(e, new OnlineComponentProvider()))),
        e._onlineComponents
    );
}
            ...
            (function __PRIVATE_readDocumentViaSnapshotListener(e, t, n, i, s) {
                const o = new __PRIVATE_AsyncObserver({
                        next: (o) => {
                            ...
                            !l && o.fromCache
                                ? s.reject(new FirestoreError($e.UNAVAILABLE, "Failed to get document because the client is offline."))
                    ...
                    u = new __PRIVATE_QueryListener(__PRIVATE_newQueryForPath(n.path), o, { includeMetadataChanges: !0, J_: !0 });
        ...
        e.asyncQueue.enqueueAndForget(async () =>
            (function __PRIVATE_executeQueryViaSnapshotListener(e, t, n, i, s) {
                const o = new __PRIVATE_AsyncObserver({
                    ...
                    u = new __PRIVATE_QueryListener(n, o, { includeMetadataChanges: !0, J_: !0 });
                return __PRIVATE_eventManagerListen(e, u);
            })(await __PRIVATE_getEventManager(e), e.asyncQueue, t, n, i)
        ),
        i.promise
                ...
                try {
                    ...
                    if (
                        await (function __PRIVATE_localStoreHasNewerBundle(e, t) {
                            ...
                            return n.persistence.runTransaction("hasNewerBundle", "readonly", (e) => n.Kr.getBundleMetadata(e, t.id)).then((e) => !!e && e.createTime.compareTo(i) >= 0);
                        })(e.localStore, i)
                    )
                        return (
                            await t.close(),
                            n._completeWith(
                                (function __PRIVATE_bundleSuccessProgress(e) {
                                    return { taskState: "Success", documentsLoaded: e.totalDocuments, bytesLoaded: e.totalBytes, totalDocuments: e.totalDocuments, totalBytes: e.totalBytes };
                                })(i)
                            ),
                    ...
                    return (
                        await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, u.ra, void 0),
...
class Firestore$1 {
    ...
    _setSettings(e) {
        if (this._settingsFrozen)
            throw new FirestoreError($e.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        (this._settings = new FirestoreSettingsImpl(e)),
            void 0 !== e.credentials &&
                (this._authCredentials = (function __PRIVATE_makeAuthCredentialsProvider(e) {
...
function connectFirestoreEmulator(e, t, n, i = {}) {
    ...
    const o = (e = __PRIVATE_cast(e, Firestore$1))._getSettings(),
        u = `${t}:${n}`;
    if (
        ("firestore.googleapis.com" !== o.host && o.host !== u && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),
        ...
        if ("string" == typeof i.mockUserToken) (t = i.mockUserToken), (n = User.MOCK_USER);
            ...
            t = (function createMockUserToken(e, t) {
                ...
                const o = Object.assign({ iss: `https://securetoken.google.com/${n}`, aud: n, iat: i, exp: i + 3600, auth_time: i, sub: s, user_id: s, firebase: { sign_in_provider: "custom", identities: {} } }, e);
                return [base64urlEncodeWithoutPadding(JSON.stringify({ alg: "none", type: "JWT" })), base64urlEncodeWithoutPadding(JSON.stringify(o)), ""].join(".");
...
function collection(e, t, ...n) {
    ...
    }
    {
        if (!(e instanceof DocumentReference || e instanceof CollectionReference))
            throw new FirestoreError($e.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
...
function collectionGroup(e, t) {
    if (((e = __PRIVATE_cast(e, Firestore$1)), __PRIVATE_validateNonEmptyArgument("collectionGroup", "collection id", t), t.indexOf("/") >= 0))
        throw new FirestoreError($e.INVALID_ARGUMENT, `Invalid collection ID '${t}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Query(
        e,
        null,
...
function refEqual(e, t) {
    return (
        ...
        (e instanceof DocumentReference || e instanceof CollectionReference) && (t instanceof DocumentReference || t instanceof CollectionReference) && e.firestore === t.firestore && e.path === t.path && e.converter === t.converter
    );
}
...
class __PRIVATE_AsyncQueueImpl {
    ...
    enqueueAfterDelay(e, t, n) {
        ...
        const i = DelayedOperation.createAndSchedule(this, e, t, n, (e) => this.au(e));
...
class LoadBundleTask {
    constructor() {
        (this._progressObserver = {}), (this._taskCompletionResolver = new __PRIVATE_Deferred()), (this._lastProgress = { taskState: "Running", totalBytes: 0, totalDocuments: 0, bytesLoaded: 0, documentsLoaded: 0 });
    }
    onProgress(e, t, n) {
...
function initializeFirestore(e, t, n) {
    ...
    if (void 0 !== t.cacheSizeBytes && void 0 !== t.localCache)
        throw new FirestoreError($e.INVALID_ARGUMENT, "cache and cacheSizeBytes cannot be specified at the same time as cacheSizeBytes willbe deprecated. Instead, specify the cache size in the cache object");
...
function __PRIVATE_configureFirestore(e) {
    ...
    (e._firestoreClient = new FirestoreClient(e._authCredentials, e._appCheckCredentials, e._queue, o)),
        (null === (n = s.localCache) || void 0 === n ? void 0 : n._offlineComponentProvider) &&
            ...
            (e._firestoreClient._uninitializedComponentsProvider = { _offlineKind: s.localCache.kind, _offline: s.localCache._offlineComponentProvider, _online: s.localCache._onlineComponentProvider });
}
        ...
        return e.asyncQueue.enqueue(async () => {
            ...
            return (
                ...
                (async function __PRIVATE_remoteStoreDisableNetwork(e) {
                    const t = __PRIVATE_debugCast(e);
                    t.C_.add(0), await __PRIVATE_disableNetworkInternal(t), t.M_.set("Offline");
                })(n)
            );
        });
    })(ensureFirestoreConfigured((e = __PRIVATE_cast(e, Firestore))));
...
function __PRIVATE_verifyNotInitialized(e) {
    if (e._initialized || e._terminated)
        throw new FirestoreError($e.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
...
class __PRIVATE_ParseContextImpl {
    constructor(e, t, n, i, s, o) {
        (this.settings = e), (this.databaseId = t), (this.serializer = n), (this.ignoreUndefinedProperties = i), void 0 === s && this.Pu(), (this.fieldTransforms = s || []), (this.fieldMask = o || []);
    }
    get path() {
    ...
    Au(e) {
        ...
        if (__PRIVATE_isWrite(this.Iu) && Nt.test(e)) throw this.mu('Document fields cannot begin and end with "__"');
    }
}
class __PRIVATE_UserDataReader {
    ...
    pu(e, t, n, i = !1) {
        return new __PRIVATE_ParseContextImpl({ Iu: e, methodName: t, gu: n, path: FieldPath$1.emptyPath(), du: !1, fu: i }, this.databaseId, this.serializer, this.ignoreUndefinedProperties);
    }
}
...
function __PRIVATE_createSentinelChildContext(e, t, n) {
    return new __PRIVATE_ParseContextImpl({ Iu: 3, gu: t.settings.gu, methodName: e._methodName, du: n }, t.databaseId, t.serializer, t.ignoreUndefinedProperties);
}
...
function __PRIVATE_parseData(e, t) {
    ...
    return (function __PRIVATE_parseScalarValue(e, t) {
        ...
        if (e instanceof GeoPoint) return { geoPointValue: { latitude: e.latitude, longitude: e.longitude } };
        ...
        if (e instanceof DocumentReference) {
            ...
            if (!i.isEqual(n)) throw t.mu(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${n.projectId}/${n.database}`);
    ...
    _apply(e) {
        ...
        return 0 === t.getFilters().length
            ...
            : ((function __PRIVATE_validateNewFilter(e, t) {
              ...
              new Query(e.firestore, e.converter, __PRIVATE_queryWithAddedFilter(e._query, t)));
    }
            ...
            for (let o = 0; o < s.length; o++) {
                ...
                if (u[o].field.isKeyField()) {
                    ...
                    if (!__PRIVATE_isCollectionGroupQuery(e) && -1 !== _.indexOf("/"))
                        throw new FirestoreError($e.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${i}() must be a plain document ID, but '${_}' contains a slash.`);
...
function __PRIVATE_parseDocumentIdValue(e, t, n) {
    if ("string" == typeof (n = getModularInstance(n))) {
        ...
        if (!__PRIVATE_isCollectionGroupQuery(t) && -1 !== n.indexOf("/"))
            throw new FirestoreError($e.INVALID_ARGUMENT, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
...
function __PRIVATE_validateNewFieldFilter(e, t) {
    ...
    if (null !== n)
        throw n === t.op
            ? new FirestoreError($e.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${t.op.toString()}' filter.`)
            : new FirestoreError($e.INVALID_ARGUMENT, `Invalid query. You cannot use '${t.op.toString()}' filters with '${n.toString()}' filters.`);
}
function __PRIVATE_validateQueryFilterConstraint(e, t) {
    if (!(t instanceof QueryFieldFilterConstraint || t instanceof QueryCompositeFilterConstraint))
        throw new FirestoreError($e.INVALID_ARGUMENT, `Function ${e}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
...
function aggregateFieldEqual(e, t) {
    ...
    return (
        ...
        (null === (n = e._internalFieldPath) || void 0 === n ? void 0 : n.canonicalString()) === (null === (i = t._internalFieldPath) || void 0 === i ? void 0 : i.canonicalString())
    );
}
                ...
                ((this._cachedChanges = (function __PRIVATE_changesFromSnapshot(e, t) {
                    if (e._snapshot.oldDocs.isEmpty()) {
                        ...
                        return e._snapshot.docChanges.map((n) => {
                            ...
                            return n.doc, { type: "added", doc: i, oldIndex: -1, newIndex: t++ };
                        });
                    }
                    {
                        ...
                        return e._snapshot.docChanges
                            ...
                            .map((t) => {
                                ...
                                return (
                                    ...
                                    { type: __PRIVATE_resultChangeType(t.type), doc: i, oldIndex: s, newIndex: o }
                                );
                            });
                    }
                })(this, t)),
...
function snapshotEqual(e, t) {
    return e instanceof DocumentSnapshot && t instanceof DocumentSnapshot
        ? e._firestore === t._firestore && e._key.isEqual(t._key) && (null === e._document ? null === t._document : e._document.isEqual(t._document)) && e._converter === t._converter
        : e instanceof QuerySnapshot && t instanceof QuerySnapshot && e._firestore === t._firestore && queryEqual(e.query, t.query) && e.metadata.isEqual(t.metadata) && e._snapshot.isEqual(t._snapshot);
}
function getDoc(e) {
...
function getDocsFromServer(e) {
    ...
    const t = __PRIVATE_cast(e.firestore, Firestore),
        n = ensureFirestoreConfigured(t),
        i = new __PRIVATE_ExpUserDataWriter(t);
    return __PRIVATE_firestoreClientGetDocumentsViaSnapshotListener(n, e._query, { source: "server" }).then((n) => new QuerySnapshot(t, i, e, n));
}
...
function updateDoc(e, t, n, ...i) {
    ...
    let u;
    return (
        (u = "string" == typeof (t = getModularInstance(t)) || t instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(o, "updateDoc", e._key, t, n, i) : __PRIVATE_parseUpdateData(o, "updateDoc", e._key, t)),
...
function onSnapshot(e, ...t) {
    ...
    return (function __PRIVATE_firestoreClientListen(e, t, n, i) {
        ...
        return (
            e.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerListen(await __PRIVATE_getEventManager(e), o)),
            () => {
                s.Na(), e.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerUnlisten(await __PRIVATE_getEventManager(e), o));
            }
        );
                    ...
                    try {
                        const e = await (function __PRIVATE_localStoreWriteLocally(e, t) {
                            ...
                            return n.persistence
                                ...
                                .then(() => ({ batchId: u.batchId, changes: __PRIVATE_convertOverlayedDocumentMapToDocumentMap(o) }));
                        })(i.localStore, t);
                        i.sharedClientState.addPendingMutation(e.batchId),
                            (function __PRIVATE_addMutationCallback(e, t, n) {
                                ...
                                i || (i = new SortedMap(__PRIVATE_primitiveComparator)), (i = i.insert(t, n)), (e.Sa[e.currentUser.toKey()] = i);
                            })(i, e.batchId, n),
                            await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(i, e.changes),
                ...
                try {
                    ...
                    i.resolve(
                        (async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
                            var i;
                            const s = __PRIVATE_debugCast(e),
                                { request: o, R_: u } = (function __PRIVATE_toRunAggregationQueryRequest(e, t, n) {
                                        ...
                                        n.forEach((e) => {
                                            ...
                                            (s[t] = e.alias),
                                                "count" === e.aggregateType
                                                    ...
                                                    : "avg" === e.aggregateType
                                                    ? o.push({ alias: t, avg: { field: __PRIVATE_toFieldPathReference(e.fieldPath) } })
                                                    : "sum" === e.aggregateType && o.push({ alias: t, sum: { field: __PRIVATE_toFieldPathReference(e.fieldPath) } });
                                        }),
                                        { request: { structuredAggregationQuery: { aggregations: o, structuredQuery: i.structuredQuery }, parent: i.parent }, R_: s }
                                    );
                                })(
                                    s.serializer,
                            ...
                            const _ = (await s.Co("RunAggregationQuery", l, o, 1)).filter((e) => !!e.result);
...
class __PRIVATE_PersistentLocalCacheImpl {
    constructor(e) {
        ...
        (this.kind = "persistent"),
            (null == e ? void 0 : e.tabManager) ? (e.tabManager._initialize(e), (t = e.tabManager)) : ((t = persistentSingleTabManager(void 0)), t._initialize(e)),
...
class __PRIVATE_SingleTabManagerImpl {
    ...
    _initialize(e) {
        (this._onlineComponentProvider = new OnlineComponentProvider()),
            (this._offlineComponentProvider = new __PRIVATE_IndexedDbOfflineComponentProvider(this._onlineComponentProvider, null == e ? void 0 : e.cacheSizeBytes, this.forceOwnership));
    }
}
        ...
        return (
            (o =
                "string" == typeof (t = getModularInstance(t)) || t instanceof FieldPath
                    ? __PRIVATE_parseUpdateVarargs(this._dataReader, "WriteBatch.update", s._key, t, n, i)
                    : __PRIVATE_parseUpdateData(this._dataReader, "WriteBatch.update", s._key, t)),
...
class Transaction extends class Transaction$1 {
    ...
    update(e, t, n, ...i) {
        ...
        return (
            (o =
                "string" == typeof (t = getModularInstance(t)) || t instanceof FieldPath
                    ? __PRIVATE_parseUpdateVarargs(this._dataReader, "Transaction.update", s._key, t, n, i)
                    : __PRIVATE_parseUpdateData(this._dataReader, "Transaction.update", s._key, t)),
...
function setIndexConfiguration(e, t) {
    ...
    if (!i._uninitializedComponentsProvider || "memory" === (null === (n = i._uninitializedComponentsProvider) || void 0 === n ? void 0 : n._offlineKind))
        ...
        return e.asyncQueue.enqueue(async () =>
            (async function __PRIVATE_localStoreConfigureFieldIndexes(e, t) {
                const n = __PRIVATE_debugCast(e),
                    i = n.indexManager,
                    s = [];
                return n.persistence.runTransaction("Configure indexes", "readwrite", (e) =>
                    i
                        .getFieldIndexes(e)
                        .next((n) =>
...
function deleteAllPersistentCacheIndexes(e) {
    e._client.verifyNotTerminated(),
        (function __PRIVATE_firestoreClientDeleteAllFieldIndexes(e) {
            ...
            .then((e) => __PRIVATE_logDebug("deleting all persistent cache indexes succeeded"))
            .catch((e) => __PRIVATE_logWarn("deleting all persistent cache indexes failed", e));
}
function __PRIVATE_setPersistentCacheIndexAutoCreationEnabled(e, t) {
    e._client.verifyNotTerminated(),
        (function __PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(e, t) {
            ...
            .then((e) => __PRIVATE_logDebug(`setting persistent cache index auto creation isEnabled=${t} succeeded`))
            .catch((e) => __PRIVATE_logWarn(`setting persistent cache index auto creation isEnabled=${t} failed`, e));
}
            ...
            new Component(
                ...
                (e, { instanceIdentifier: t, options: n }) => {
                    const s = e.getProvider("app").getImmediate(),
                        o = new Firestore(
                            new __PRIVATE_FirebaseAuthCredentialsProvider(e.getProvider("auth-internal")),
                            new __PRIVATE_FirebaseAppCheckTokenProvider(e.getProvider("app-check-internal")),
                    ...
                    return (n = Object.assign({ useFetchStreams: i }, n)), o._setSettings(n), o;
                },
                "PUBLIC"
